...
| Contract                                                                                                                                         | Coverage                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| Matched core-generate/Workflow-stream responses, final/all-step tools, unresolved client calls, defaults, preparation precedence, callback order | `workflow-agent-contract.test.ts`, using `__fixtures__/agent-model.ts`                                                       |
