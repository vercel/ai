...
Depending on the type of application you're building, you may want to cache the responses you receive from your AI provider, at least for temporarily.
...
This example uses [Vercel KV](https://vercel.com/storage/kv) and Next.js to cache the an OpenAI response for 1 hour.
