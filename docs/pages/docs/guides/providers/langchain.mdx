...
It provides immensely useful tools and abstractions for working with AI models and agents,
as well as vector stores and other data sources for retrieval augmented generation (RAG).
...
For more usage examples, including agents and retrieval, you can check out the [official starter template](https://github.com/langchain-ai/langchain-nextjs-template).
