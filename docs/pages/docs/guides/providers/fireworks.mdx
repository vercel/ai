...
Create a `.env` file in your project root and add your Fireworks API Key and set the base URL to \`https://api.fireworks.ai/inference/v1\`:
...
export async function POST(req: Request) {
  ...
  // Ask Fireworks for a streaming chat completion given the prompt
...
export async function POST(req: Request) {
  ...
  // Ask Fireworks for a streaming completion given the prompt
  // using Llama 2 70b model.
  // @see https://app.fireworks.ai/models/fireworks/llama-v2-70b-chat
