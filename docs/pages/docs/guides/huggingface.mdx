...
With Inference Endpoints, you can use state of the art open-source models requiring more compute such as [Falcon 40B](https://huggingface.co/blog/inference-endpoints-llm).
