...
In order to support recursively calling functions and to keep the message context in the function calls, you can use `createFunctionCallMessages` to construct the relevant "assistant" and "function" messages for you.
