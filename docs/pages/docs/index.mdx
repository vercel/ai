...
{<div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-8">
  ...
  <IntegrationCard href="/docs/guides/providers/lmnt" title="LMNT" description="LMNT is a text-to-speech provider. It brings lifelike speech to customers that need quality, speed, and flexibility." />
</div>}
