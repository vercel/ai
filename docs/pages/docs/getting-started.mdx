...
<Callout>
  The below example uses a completion API and the `useCompletion` hook. If you want to see a chat example (using ChatGPT 3.5-turbo), see a [chat guide](https://sdk.vercel.ai/docs/guides/openai#guide-chat-bot).
</Callout>
