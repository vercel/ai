...
<Callout>
  <strong>
    This API has been deprecated and will be removed in a future release. See [Generative UI](/docs/concepts/generative-ui) for the recommended approach to streaming React UI.
  </strong>
</Callout>
