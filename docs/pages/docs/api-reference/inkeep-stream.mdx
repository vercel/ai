...
<OptionTable
  options={[
    [
      'onRecordsCited',
      '(records_cited: InkeepRecordsCited) => void',
...
For the full type definitions and documentation of the Inkeep API, see the [Inkeep Chat SDK](https://github.com/inkeep/chat-api-ts).
