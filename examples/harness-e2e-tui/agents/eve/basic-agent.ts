...
loadEnvFiles({ entrypointUrl: import.meta.url });
 ...
 * runtime. This inert provider handles the framework's working-directory
 * probes and lifecycle calls while all Eve tool execution stays inside the
 * configured remote Eve agent.
 */
