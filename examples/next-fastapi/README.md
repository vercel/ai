...
cd ai/examples/next-fastapi
```

You will also need [Python 3.10+](https://www.python.org/downloads) and [virtualenv](https://virtualenv.pypa.io/en/latest/installation.html) installed to run the FastAPI server.
