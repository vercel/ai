...
3. Set the required OpenAI environment variable from your Clerk project as shown at [the example env file](./.env.local.example).
...
- [Vercel AI Playround](https://play.vercel.ai)
