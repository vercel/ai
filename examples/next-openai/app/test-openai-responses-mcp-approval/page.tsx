...
import OpenAIMCPView from '@/components/tool/openai-mcp-view-approval';
import { useChat } from '@ai-sdk/react';
import {
  DefaultChatTransport,
  lastAssistantMessageIsCompleteWithApprovalResponses,
} from 'ai';
import { OpenAIResponsesMCPMessage } from '../api/chat-openai-responses-mcp-approval/route';

export default function TestOpenAIResponsesMCP() {
  const { status, sendMessage, messages, addToolApprovalResponse } =
    useChat<OpenAIResponsesMCPMessage>({
