...
export const weatherApprovalGitHubCopilotHarnessAgent = new HarnessAgent({
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/github-copilot/weather-approval',
      }),
    ],
  },
});

export type WeatherApprovalGitHubCopilotHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof weatherApprovalGitHubCopilotHarnessAgent.tools>
>;
