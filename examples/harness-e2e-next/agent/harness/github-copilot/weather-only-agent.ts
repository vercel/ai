...
export const weatherGitHubCopilotHarnessAgent = new HarnessAgent({
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/github-copilot/weather-only',
      }),
    ],
  },
});
 ...
 */
export type WeatherGitHubCopilotHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof weatherGitHubCopilotHarnessAgent.tools>
>;
