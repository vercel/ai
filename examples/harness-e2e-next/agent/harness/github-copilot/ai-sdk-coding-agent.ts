...
export const githubCopilotAiSdkCodingHarnessAgent = new HarnessAgent({
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof githubCopilotAiSdkCodingHarnessAgent>` once
 ...
 */
export type GitHubCopilotAiSdkCodingHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof githubCopilotAiSdkCodingHarnessAgent.tools>
>;
