...
export const githubCopilotHarnessAgent = new HarnessAgent({
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/github-copilot/basic',
      }),
    ],
  },
});
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof githubCopilotHarnessAgent>` once
 ...
 */
export type GitHubCopilotHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof githubCopilotHarnessAgent.tools>
>;
