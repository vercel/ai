...
export const weatherApprovalFxHarnessAgent = new HarnessAgent({
  harness: fx,
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/fx/weather-approval',
      }),
    ],
  },
});

export type WeatherApprovalFxHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof weatherApprovalFxHarnessAgent.tools>
>;
