...
export const fxHarnessAgent = new HarnessAgent({
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/fx/basic',
      }),
    ],
  },
});
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof fxHarnessAgent>` once
 ...
 */
export type FxHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof fxHarnessAgent.tools>
>;
