...
export const grokBuildACPHarnessAgent = new HarnessAgent({
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/acp-grok-build/basic',
      }),
    ],
  },
});
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof grokBuildACPHarnessAgent>` once
 ...
 */
export type GrokBuildACPHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof grokBuildACPHarnessAgent.tools>
>;
