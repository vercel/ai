...
export const codexACPAiSdkCodingHarnessAgent = new HarnessAgent({
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof codexACPAiSdkCodingHarnessAgent>` once
 ...
 */
export type CodexACPAiSdkCodingHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof codexACPAiSdkCodingHarnessAgent.tools>
>;
