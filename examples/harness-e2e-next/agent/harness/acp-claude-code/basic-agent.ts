...
export const claudeCodeACPHarnessAgent = new HarnessAgent({
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/acp-claude-code/basic',
      }),
    ],
  },
});
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof claudeCodeACPHarnessAgent>` once
 ...
 */
export type ClaudeCodeACPHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof claudeCodeACPHarnessAgent.tools>
>;
