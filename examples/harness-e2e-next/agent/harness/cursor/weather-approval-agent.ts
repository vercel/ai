...
export const weatherApprovalCursorHarnessAgent = new HarnessAgent({
  harness: cursor,
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/cursor/weather-approval',
      }),
    ],
  },
});

export type WeatherApprovalCursorHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof weatherApprovalCursorHarnessAgent.tools>
>;
