...
export const cursorAiSdkCodingHarnessAgent = new HarnessAgent({
  harness: cursor,
  instructions,
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof cursorAiSdkCodingHarnessAgent>` once
 ...
 */
export type CursorAiSdkCodingHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof cursorAiSdkCodingHarnessAgent.tools>
>;
