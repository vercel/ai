...
export const weatherCursorHarnessAgent = new HarnessAgent({
  harness: cursor,
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({
        dir: '.harness-observability/cursor/weather',
      }),
    ],
  },
});
 ...
 */
export type WeatherCursorHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof weatherCursorHarnessAgent.tools>
>;
