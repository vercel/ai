...
export const aiSdkCodingClineHarnessAgent = new HarnessAgent({
  harness: cline,
  instructions,
 ...
 */
export type AiSdkCodingClineHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof aiSdkCodingClineHarnessAgent.tools>
>;
