...
export const clineHarnessAgent = new HarnessAgent({
  harness: cline,
  ...
  telemetry: {
    integrations: [
      createTraceTreeReporter(),
      createFileReporter({ dir: '.harness-observability/cline/basic' }),
    ],
  },
});
 ...
 *
 * TODO: revert to `InferAgentUIMessage<typeof clineHarnessAgent>` once
 ...
 */
export type ClineHarnessAgentMessage = UIMessage<
  unknown,
  never,
  InferUITools<typeof clineHarnessAgent.tools>
>;
