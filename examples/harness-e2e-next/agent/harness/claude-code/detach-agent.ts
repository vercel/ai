 ...
 * The chat UI reuses `ClaudeCodeHarnessChat`, which sources its message type
 * from `basic-agent`, so no message-type export is needed here.
 */
export const claudeCodeDetachHarnessAgent = new HarnessAgent({
  harness: claudeCode,
