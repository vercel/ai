...
import type { WeatherPiHarnessAgentMessage } from '@/agent/harness/pi/weather-agent';
...
export default function WeatherPiHarnessChat({
  apiRoute,
  exampleLabel,
}: {
  apiRoute: string;
  ...
  } = useChat<WeatherPiHarnessAgentMessage>({
    id: chatId,
