...
import type { EveHarnessAgentMessage } from '@/agent/harness/eve/basic-agent';
...
export default function EveHarnessChat({
  apiRoute,
  exampleLabel,
}: {
  apiRoute: string;
  ...
  const { error, status, sendMessage, messages, regenerate } =
    useChat<EveHarnessAgentMessage>({
      id: chatId,
  ...
  return (
    <div className="flex flex-col pt-12 pb-24 mx-auto w-full max-w-5xl stretch">
      <h1 className="mb-2 text-xl font-bold">Eve — {exampleLabel}</h1>
              ...
              case 'tool-connection_search': {
                ...
                return (
                  <HarnessToolView
                    ...
                    toolArg={typeof toolArg === 'string' ? toolArg : undefined}
                    state={part.state}
                    output={
