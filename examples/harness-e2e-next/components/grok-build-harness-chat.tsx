...
import type { GrokBuildHarnessAgentMessage } from '@/agent/harness/grok-build/basic-agent';
...
export default function GrokBuildHarnessChat({
  apiRoute,
  exampleLabel,
}: {
  apiRoute: string;
  ...
  const { error, status, sendMessage, messages, regenerate } =
    useChat<GrokBuildHarnessAgentMessage>({
      id: chatId,
