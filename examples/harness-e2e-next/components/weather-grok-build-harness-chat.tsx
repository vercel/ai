...
import type { WeatherGrokBuildHarnessAgentMessage } from '@/agent/harness/grok-build/weather-agent';
...
export default function WeatherGrokBuildHarnessChat({
  apiRoute,
  exampleLabel,
}: {
  apiRoute: string;
  ...
  } = useChat<WeatherGrokBuildHarnessAgentMessage>({
    id: chatId,
  ...
  return (
    <div className="flex flex-col pt-12 pb-24 mx-auto w-full max-w-5xl stretch">
      <h1 className="mb-2 text-xl font-bold">Grok Build — {exampleLabel}</h1>
