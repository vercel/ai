...
import type { CursorHarnessAgentMessage } from '@/agent/harness/cursor/basic-agent';
...
export default function CursorHarnessChat({
  apiRoute,
  exampleLabel,
}: {
  apiRoute: string;
  ...
  const { error, status, sendMessage, messages, regenerate } =
    useChat<CursorHarnessAgentMessage>({
      id: chatId,
  ...
  return (
    <div className="flex flex-col pt-12 pb-24 mx-auto w-full max-w-5xl stretch">
      <h1 className="mb-2 text-xl font-bold">Cursor — {exampleLabel}</h1>
