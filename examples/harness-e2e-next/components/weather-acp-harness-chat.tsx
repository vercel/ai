...
import type { WeatherClaudeCodeACPHarnessAgentMessage } from '@/agent/harness/acp-claude-code/weather-agent';
...
export default function WeatherACPHarnessChat({
  apiRoute,
  exampleLabel,
  harnessLabel,
}: {
  ...
  } = useChat<WeatherClaudeCodeACPHarnessAgentMessage>({
    id: chatId,
