          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            {suggestions && suggestions.length > 0 && (
              <div className="flex flex-col gap-2 w-full max-w-md">
                <div className="flex items-center justify-center gap-2 text-xs text-[var(--foreground-muted)] mb-1">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {suggestions.map((suggestion, index) => (
                    <button
                      ...
                      className="px-4 py-2 text-sm bg-[var(--background-tertiary)] border border-[var(--border)] rounded-full text-[var(--foreground-secondary)] hover:text-[var(--foreground)] hover:border-[var(--accent)] hover:bg-[var(--accent-light)] transition-all"
                    >
                      {suggestion}
                    </button>
                  ))}
