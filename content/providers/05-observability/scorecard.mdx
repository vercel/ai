...
You'll need to sign up at https://app.scorecard.io and get your Telemetry Key from your project's Traces section.
...
```bash
OTEL_EXPORTER_OTLP_ENDPOINT=https://telemetry.getscorecard.ai:4318
OTEL_EXPORTER_OTLP_HEADERS="Authorization=Bearer <Your Scorecard Telemetry Key>"
```

Next, create an `instrumentation.ts` file in your project root to initialize OpenTelemetry:
