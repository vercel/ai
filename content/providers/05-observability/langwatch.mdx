...
Finally, register the `OpenTelemetryIntegration` at the top of your route files and enable `experimental_telemetry` tracking on the AI SDK calls you want to trace:
