...
<Note>
  ...
  docs](https://arize.com/docs/ax/integrations/typescript/vercel).
</Note>
...
<Note>
  ...
  [docs](https://arize.com/docs/ax/observe/tracing/configure-tracing-options/customize-auto-instrumentation#batch-vs-simple-span-processor).
</Note>

### Next.js

With Next.js, use the `OpenInferenceSpanProcessor` with `registerOtel` from `@vercel/otel`.
...
- Rerunning spans in the [prompt playground](https://arize.com/docs/ax/develop/prompt-playground) to iterate and compare prompts and parameters
