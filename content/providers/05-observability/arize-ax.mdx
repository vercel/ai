...
You must register the `OpenTelemetryIntegration` at the top of your route files and set the `experimental_telemetry` flag to true in all calls using the AI SDK.
