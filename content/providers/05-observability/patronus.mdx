...
Once you've installed `@ai-sdk/otel` and added `registerTelemetryIntegration` to your `instrumentation.ts`, telemetry is captured automatically. Pass `telemetry` to attach metadata:
