---
title: Observability with Braintrust
...
You can wrap the Vercel AI SDK in Braintrust to automatically log your requests.
...
Braintrust supports OTel logging for popular libraries like the Vercel AI SDK. To set up Braintrust as an [OpenTelemetry](https://opentelemetry.io/docs/) backend, you'll need to route the traces to Braintrust's OpenTelemetry endpoint, set your API key, and specify a parent project or experiment.
