...
Install `@ai-sdk/otel` and register the `OpenTelemetryIntegration` at the top of your route files. You can then use the `experimental_telemetry` option to enable telemetry on supported AI SDK function calls:
