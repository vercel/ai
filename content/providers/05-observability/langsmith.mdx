---
title: LangSmith
description: Monitor, evaluate and your AI SDK application with LangSmith
---
...
Use of LangChain's open source frameworks is not necessary, and LangSmith integrates with the [Vercel AI SDK](/docs/introduction) via the `AISDKExporter` OpenTelemetry trace exporter.
...
Install an AI SDK model provider and the [LangSmith client SDK](https://npmjs.com/package/langsmith).
The code snippets below will use Vercel's OpenAI integration, but you can use any [other supported provider](/docs/foundations/providers-and-models) as well.
...
export OPENAI_API_KEY=<your-openai-api-key> # The examples use the OpenAI API (not necessary in general)
```
...
First, create a `instrumentation.js` file in your project root.
...
- [LangSmith guide on tracing with the Vercel AI SDK](https://docs.smith.langchain.com/observability/how_to_guides/tracing/trace_with_vercel_ai_sdk)
