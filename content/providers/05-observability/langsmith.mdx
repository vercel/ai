...
<Note>
  ...
  If you are using AI SDK v4 an older version of the `langsmith` client, see the legacy
...
- [LangSmith evaluation](https://docs.langchain.com/langsmith/evaluation-tab)
