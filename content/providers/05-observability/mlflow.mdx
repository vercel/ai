...
Then register the `OpenTelemetryIntegration` at the top of your route files and enable telemetry where you call the AI SDK:

```ts filename="route.ts" highlight="1-5,12"
