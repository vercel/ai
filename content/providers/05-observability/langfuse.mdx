...
Install `@ai-sdk/otel` and register the `OpenTelemetry` in your `instrumentation.ts` file. Once registered, telemetry is emitted automatically for every AI SDK call:
