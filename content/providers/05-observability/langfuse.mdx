...
First, install `@ai-sdk/otel` and register the `OpenTelemetryIntegration` at application startup to enable OpenTelemetry span collection:
...
Then enable telemetry on each request that you want to trace:
