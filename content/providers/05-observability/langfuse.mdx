...
on the [next-openai](https://github.com/vercel/ai/tree/main/examples/next-openai-pages) template to showcase the integration of Langfuse with Next.js and AI SDK.
