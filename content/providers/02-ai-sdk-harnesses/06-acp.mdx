...
- `clientApp`: optional client attribution with `name` and `version`. It
  ...
  available to Gateway route placeholders.
...
Gateway route supplies versioned attribution through Claude's supported
...
authentication. The Gateway route supplies client name and version attribution.
