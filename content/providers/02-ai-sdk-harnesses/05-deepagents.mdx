...
[Deep Agents](https://github.com/deep-agents/deepagents), a LangGraph-based agent
...
The adapter exposes these common Deep Agents built-ins through `agent.tools`:
...
- **Cross-process resume, turn continuation, and suspend/detach** are not
  supported yet — Deep Agents holds conversation state in memory (LangGraph
