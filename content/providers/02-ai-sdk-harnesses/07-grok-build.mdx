...
to the Grok Build process in the sandbox.
...
With direct authentication, the adapter forwards `XAI_API_KEY`. With AI
Gateway, it supplies the Gateway credential as `XAI_API_KEY`, maps the Gateway
