...
The [Hyperbolic](https://hyperbolic.ai/) provider for the [Vercel AI SDK](https://sdk.vercel.ai/docs) gives access to any model found at <https://app.hyperbolic.ai/models>.
