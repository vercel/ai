...
Learn more about Requesty's capabilities in the [Requesty Documentation](https://requesty.ai/docs).
...
<Tabs items={['Linux/Mac', 'Windows CMD', 'Windows PowerShell']}>
  <Tab>
    <Snippet text="export REQUESTY_API_KEY=your_api_key_here" dark />
  </Tab>
  <Tab>
    <Snippet text="set REQUESTY_API_KEY=your_api_key_here" dark />
  </Tab>
  <Tab>
    <Snippet text='$env:REQUESTY_API_KEY="your_api_key_here"' dark />
  </Tab>
</Tabs>
...
- [Requesty Provider Repository](https://github.com/requestyai/ai-sdk)
- [Requesty Documentation](https://requesty.ai/docs)
