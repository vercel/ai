...
[threepointone/workers-ai-provider](https://github.com/threepointone/workers-ai-provider/) is a community provider that allows you to use Cloudflare's [Workers AI](https://ai.cloudflare.com/) models with the Vercel AI SDK.
