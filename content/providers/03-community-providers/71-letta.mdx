...
The [Letta AI-SDK provider](https://github.com/letta-ai/vercel-ai-sdk-provider) is the official provider for the [Letta](https://docs.letta.com) platform. It allows you to integrate build stateful agents using Letta and integrate them into your applications using the Vercel AI SDK.
...
For more information on the Letta API, please refer to the [Letta API documentation](https://docs.letta.com/api-reference).
