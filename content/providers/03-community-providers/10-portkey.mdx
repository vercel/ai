...
[Portkey](https://portkey.ai/?utm_source=vercel&utm_medium=docs&utm_campaign=integration) natively integrates with the Vercel AI SDK to make your apps production-ready and reliable. Import Portkey's Vercel package and use it as a provider in your Vercel AI app to enable all of Portkey's features:
...
Learn more at [Portkey docs for Vercel AI SDK](https://docs.portkey.ai/docs/integrations/libraries/vercel) 


# Portkey

Portkey is a provider that integrates with the Vercel AI SDK to enhance your AI applications with features like observability, interoperability across multiple LLMs, guardrails, caching, and request routing.
...
Note: 
- Portkey supports Tool use with Vercel AI SDK
