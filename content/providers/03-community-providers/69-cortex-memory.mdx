...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  <Tab value="npm">
    ```bash npm install @cortexmemory/vercel-ai-provider @cortexmemory/sdk ai
    convex ```
  </Tab>
  <Tab value="pnpm">
    ```bash pnpm add @cortexmemory/vercel-ai-provider @cortexmemory/sdk ai
    convex ```
  </Tab>
  <Tab value="yarn">
    ```bash yarn add @cortexmemory/vercel-ai-provider @cortexmemory/sdk ai
    convex ```
  </Tab>
</Tabs>
