...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    <Snippet text="pnpm add @vectorize-io/hindsight-ai-sdk @vectorize-io/hindsight-client" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @vectorize-io/hindsight-ai-sdk @vectorize-io/hindsight-client" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @vectorize-io/hindsight-ai-sdk @vectorize-io/hindsight-client" dark />
  </Tab>
  <Tab>
    <Snippet text="bun add @vectorize-io/hindsight-ai-sdk @vectorize-io/hindsight-client" dark />
  </Tab>
</Tabs>
