---
title: 'Sarvam'
description: 'Learn how to use the Sarvam AI provider for the Vercel AI SDK.'
---

# Sarvam Provider

The Sarvam AI Provider is a library developed to integrate with the Vercel AI SDK. This library brings Speech to Text (STT) capabilities to your applications, allowing for seamless interaction with audio and text data.
