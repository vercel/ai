...
description: Learn how to use the Cloudflare Workers AI provider with the Vercel AI SDK.
---
...
### Enabling AI in Cloudflare Workers Project

First, setup an AI binding in your Cloudflare Workers project `wrangler.toml` file:
