---
title: Workers AI
description: Learn how to use the Workers AI provider with the Vercel AI SDK.
---

# Workers AI

[threepointone/workers-ai-provider](https://github.com/threepointone/workers-ai-provider/) is a community provider that enables Cloudflare's [Workers AI](https://ai.cloudflare.com/) models for use the Vercel AI SDK.

## Setup

The Workers AI provider is available in the `workers-ai-provider` module. You can install it with:
...
### Enabling AI in Workers Project

First, setup an AI binding in your Workers project `wrangler.toml` file:
...
In your Worker, import the factory function and create a new AI provider:
...
You can use Workers AI language models to generate text with the `generateText` or `streamText` function:
...
Some Workers AI language models can also be used with the `generateObject` function:
