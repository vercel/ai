...
The `LanguageModelV2` interface defines the core methods your provider must implement:
...
- **doGenerate/doStream**: Core methods for non-streaming and streaming generation
