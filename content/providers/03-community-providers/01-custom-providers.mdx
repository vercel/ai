...
The V2 prompt format (`LanguageModelV3Prompt`) is designed as a flexible message array that supports multimodal inputs:
...
import { LanguageModelV2, LanguageModelV3CallOptions } from '@ai-sdk/provider';
