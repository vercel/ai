---
title: Voyage AI (Community)
description: Learn how to use the Voyage AI community provider for multimodal embeddings.
---

# Voyage AI Provider (Community)

<Note>
  For **text embeddings** and **reranking**, use the official [`@ai-sdk/voyage`](/providers/ai-sdk-providers/voyage) provider instead.

  This community provider offers additional support for **image** and **multimodal** embeddings not yet available in the official provider.
</Note>

[patelvivekdev/voyage-ai-provider](https://github.com/patelvivekdev/voyageai-ai-provider) is a community provider that uses [Voyage AI](https://www.voyageai.com) to provide Embedding support for the AI SDK, including image and multimodal embeddings.
