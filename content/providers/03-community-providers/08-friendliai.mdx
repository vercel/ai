...
The [FriendliAI](https://friendli.ai/) provider contains language model support for the [Friendli Serverless Endpoints](https://friendli.ai/products/serverless-endpoints) and Custom Models via [Dedicated Endpoints](https://docs.friendli.ai/sdk/integrations/vercel-ai-sdk).

[FriendliAI](https://friendli.ai/) provider supports custom models via [Friendli Dedicated Endpoints](https://friendli.ai/products/dedicated-endpoints) and all models on [Friendli Serverless endpoints](https://friendli.ai/products/serverless-endpoints).
...
<Note type="warning">**Built-in tools** are still in beta.</Note>
