...
<Note>
To access [more models](https://friendli.ai/models), visit the [Friendli Dedicated Endpoints](https://docs.friendli.ai/sdk/integrations/vercel-ai-sdk) documentation to deploy your custom models.
</Note>
