...
const { embedding } = await embed({
  model: togetherai.textEmbeddingModel('togethercomputer/m2-bert-80M-8k-retrieval'),
...
<Note>
  For a complete list of available embedding models, see the [Together.ai
  models page](https://docs.together.ai/docs/serverless-models#embedding-models).
</Note>
