...
- **reasoningSummary** _'auto' | 'concise' | 'detailed'_

  Control the reasoning summary returned by the model.
...
- **include** _Array&lt;'file_search_call.results' | 'reasoning.encrypted_content' | 'no_inline_citations'&gt;_

  Specify additional output data or disable inline citations.
