...
- **uploadUrl** _string_
  ...
  Signed URL where xAI uploads the generated video using HTTP PUT. When xAI
  does not also return a downloadable video URL, the destination is exposed as
  `providerMetadata.xai.uploadUrl`.
