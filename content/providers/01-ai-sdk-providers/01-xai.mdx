...
[Batch API](https://docs.x.ai/developers/advanced-api-usage/batch-api). Pass an
xAI Responses model to the AI SDK's [Text Batches](/docs/ai-sdk-core/text-batches)
