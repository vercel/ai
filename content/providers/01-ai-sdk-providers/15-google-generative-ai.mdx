...
<<<<<<< HEAD:content/providers/01-ai-sdk-providers/15-google-generative-ai.mdx
...
>>>>>>> f1266498a2 (feat: use forward-compatible capability defaults for unknown Google Gemini models (#17816)):content/providers/01-ai-sdk-providers/15-google.mdx
