...
You can create models that call the [ElevenLabs voice changer API](https://elevenlabs.io/voice-changer)
using the `.changer()` factory method.

```ts
const model = elevenlabs.voiceChanger('eleven_multilingual_sts_v2');
```
...
| Model                        | Change Voice        |
| ---------------------------- | ------------------- |
| `eleven_multilingual_sts_v2` | <Check size={18} /> |
| `eleven_english_sts_v2`      | <Check size={18} /> |
