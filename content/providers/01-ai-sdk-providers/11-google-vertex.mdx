...
The latest Google Vertex AI models list is available [here](https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/inference#supported-models) documentation for up to date information, including:
