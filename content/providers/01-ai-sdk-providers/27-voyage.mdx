...
- **outputDimension** _number_
  ...
  Supported by models with flexible dimensions (e.g. `voyage-4-large`, `voyage-4`, `voyage-4-lite`, `voyage-4-nano`, `voyage-code-3`, `voyage-3-large`, `voyage-3.5`, `voyage-3.5-lite`).
