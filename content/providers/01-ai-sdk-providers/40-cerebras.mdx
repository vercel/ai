...
| -------------------------------- | ------------------- | ----------------- | ---------- | -------------- | ------------------- |
| `llama3.1-8b`                    | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Cross size={18} /> |
| `llama-3.3-70b`                  | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Cross size={18} /> |
| `gpt-oss-120b`                   | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Check />           |
| `qwen-3-32b`                     | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Check />           |
| `qwen-3-235b-a22b-instruct-2507` | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Cross size={18} /> |
| `qwen-3-235b-a22b-thinking-2507` | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Cross size={18} /> |
| `zai-glm-4.6`                    | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Cross size={18} /> |
| `zai-glm-4.7`                    | <Cross size={18} /> | <Check />         | <Check />  | <Check />      | <Check />           |
