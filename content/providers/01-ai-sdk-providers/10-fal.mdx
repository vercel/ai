...
You can create models that call the [Fal transcription API](https://fal.ai/docs/api-reference/transcription)
using the `.transcription()` factory method.

The first argument is the model id e.g. `whisper`.

```ts
const model = fal.transcription('whisper');
```
...
| `wizper`  | <Check size={18} /> | <Cross size={18} /> | <Cross size={18} /> | <Cross size={18} /> |
