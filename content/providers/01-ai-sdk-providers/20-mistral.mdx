...
The latest Mistral models list is available [here](https://docs.mistral.ai/getting-started/models/models_overview/) documentation for up to date information, including:
