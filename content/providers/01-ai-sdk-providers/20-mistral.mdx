...
These models return raw text that includes `<think>...</think>` tags containing the reasoning process:
...
console.log(text);
// Output includes: <think>Let me calculate this step by step...</think>
// followed by the final answer
```

The reasoning content remains in the raw text output. If you need to separate the reasoning from the final answer, you can use the [extract reasoning middleware](/docs/ai-sdk-core/middleware).
