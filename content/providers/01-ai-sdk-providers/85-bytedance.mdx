...
const byteDance = createByteDance({
  apiKey: 'your-api-key', // optional, defaults to BYTEDANCE_ARK_API_KEY environment variable
...
ByteDance offers the Seedance family of video generation models. To use these models, you must first [create an inference endpoint](https://docs.byteplus.com/en/docs/ModelArk/Video_Generation_API) in the BytePlus ModelArk console. Each endpoint you create will have a unique endpoint ID (e.g., `ep-xxxxxxxxxxxx-xxxxx`) that you pass to `byteDance.video()`.
