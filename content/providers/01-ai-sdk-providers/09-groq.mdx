...
- **timestampGranularities** _string[]_
  ...
  - The AI SDK prioritizes the Groq API's segments over words when populating the SDK's [`segments`](https://ai-sdk.dev/docs/ai-sdk-core/transcription) property. To read both segments and words, use the full responses property.
