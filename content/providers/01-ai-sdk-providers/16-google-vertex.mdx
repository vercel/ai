...
With [URL Context](https://cloud.google.com/vertex-ai/generative-ai/docs/url-context), certain Gemini models on Vertex AI can retrieve and analyze content from provided URLs.

Supported models: Gemini 2.5 Flash-Lite, 2.5 Pro, 2.5 Flash, 2.0 Flash
...
With [Google Search](https://cloud.google.com/vertex-ai/generative-ai/docs/grounding/grounding-with-google-search), certain Gemini models on Vertex AI can access real-time web information.
