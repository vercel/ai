...
The Replicate provider supports the following factory methods:

```ts
// Recommended: Image model factory
...
The Replicate provider does not support:

- **Language models** - Use `languageModel()` will throw a `NoSuchModelError`
