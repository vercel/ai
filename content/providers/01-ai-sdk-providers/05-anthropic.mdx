...
The first argument is the model id, e.g. `claude-opus-5`.
...
- `anthropic.languageModel('claude-opus-5')` - Creates a language model
- `anthropic.chat('claude-opus-5')` - Alias for `languageModel`
- `anthropic.messages('claude-opus-5')` - Alias for `languageModel`
