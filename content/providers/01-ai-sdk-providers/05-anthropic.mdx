...
The latest Anthropic models list is available [here](https://docs.anthropic.com/en/docs/about-claude/models) documentation for up to date information, including:
