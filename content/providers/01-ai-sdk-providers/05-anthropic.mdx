...
In `@ai-sdk/anthropic>=1.2.13`, detailed usage information on the specific type of cache created is
available in `providerMetadata`.
...
//     cache_creation: { ephemeral_5m_input_tokens: 0, ephemeral_1h_input_tokens: 2118 },
//     output_tokens: 1,
