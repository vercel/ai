...
- `enableBetaFineGrainedToolStreaming` _boolean_
  ...
  <Note type="warning">
    Enabling this beta can cause parsing errors with some tool input schemas due
    to invalid JSON output from the LLM. See [the beta
    docs](https://docs.anthropic.com/en/docs/agents-and-tools/tool-use/fine-grained-tool-streaming)
