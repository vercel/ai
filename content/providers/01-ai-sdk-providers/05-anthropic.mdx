...
const result = await generateText({
  ...
  tools: {
    web_search: anthropic.tools.web_search_20250305(),
  },
});
```
...
Refer to the [Anthropic Web Search Tool documentation](https://docs.anthropic.com/en/docs/build-with-claude/tool-use/web-search-tool) for more details on the optional arguments.
...
| Model                        | Image Input         | Object Generation   | Tool Usage          | Computer Use        | Web Search Tool     |
| ---------------------------- | ------------------- | ------------------- | ------------------- | ------------------- | ------------------- |
...
| `claude-3-5-sonnet-20240620` | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Cross size={18} /> | <Cross size={18} /> |
