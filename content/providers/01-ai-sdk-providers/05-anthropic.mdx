...
Anthropic has reasoning support for Claude models. There are two thinking modes:

#### Adaptive Thinking

For `claude-sonnet-4-6`, `claude-opus-4-6`, and newer models, use adaptive thinking. The model automatically decides when and how much to think based on the complexity of the request—no token budget needed.
...
For `claude-opus-4-20250514`, `claude-sonnet-4-20250514`, and `claude-sonnet-4-5-20250929`, use the `enabled` type with a `budgetTokens` parameter to set a maximum thinking token budget.
