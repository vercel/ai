...
It uses the Messages API's structured-output support for Choice and Score
...
The adapter returns no probability distributions and rejects Boolean before a
request because it cannot supply the required probability of true. It respects
