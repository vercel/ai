...
Newer models (e.g. `claude-opus-4-20250514` and `claude-sonnet-4-20250514`) support
**adaptive thinking** mode, where Anthropic automatically decides how much reasoning to
apply based on the complexity of the request. Use `{ type: 'adaptive' }` instead of
specifying a fixed `budgetTokens`:
