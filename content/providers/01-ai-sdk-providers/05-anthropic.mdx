...
<Note>
  Different versions of the text editor tool are available depending on your Claude model:
  - **textEditor_20250728**: Latest version for Claude 4 models (Sonnet 4, Opus 4, Opus 4.1) with optional `maxCharacters` parameter
  - **textEditor_20250429**: Previous version for Claude 4 models  
  - **textEditor_20250124**: For Claude Sonnet 3.7
  - **textEditor_20241022**: For Claude Sonnet 3.5 (deprecated)
  
  Claude 4 models do not support the `undo_edit` command.
</Note>
...
const response = await generateText({
  model: anthropic('claude-opus-4-20250514'),
  prompt: "Please examine the large log file at /var/log/application.log and summarize any errors",
  tools: {
