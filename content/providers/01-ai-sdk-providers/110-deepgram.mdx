...
You can create models that call the [Deepgram transcription API](https://www.deepgram.com/docs/api-reference/transcription)
...
| ----------------------- | ------------------- | ------------------- | ------------------- | ------------------- |
| `nova-3` (+ variants)   | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
| `nova-2` (+ variants)   | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
| `nova` (+ variants)     | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
| `enhanced` (+ variants) | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
| `base` (+ variants)     | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
