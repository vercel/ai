...
| --------------------- | ------------------- | ----------------- | ------------------- | ------------------- |
| `sonar-deep-research` | <Cross size={18} /> | <Check />         | <Cross size={18} /> | <Cross size={18} /> |
| `sonar-reasoning-pro` | <Check />           | <Check />         | <Cross size={18} /> | <Cross size={18} /> |
| `sonar-reasoning`     | <Check />           | <Check />         | <Cross size={18} /> | <Cross size={18} /> |
| `sonar-pro`           | <Check />           | <Check />         | <Cross size={18} /> | <Cross size={18} /> |
| `sonar`               | <Check />           | <Check />         | <Cross size={18} /> | <Cross size={18} /> |
