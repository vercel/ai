...
The [Perplexity](https://sonar.perplexity.ai) provider offers access to Sonar API - a powerful answer engine with real-time web search capabilities. It provides unparalleled real-time, web-wide research and Q&A capabilities with search grounding.
...
Perplexity models can be used in the `streamText`, `generateObject`, `streamObject`, and `streamUI` functions
