...
Application inference profile ARNs do not identify their underlying model.
Declare the model family when creating a chat model so Anthropic-specific
features, including native structured output, remain available:
