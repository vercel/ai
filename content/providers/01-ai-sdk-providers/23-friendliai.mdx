...
The Friendli provider is available via the `@ai-sdk/friendli` module.
You can install it with:

<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    <Snippet text="pnpm add @ai-sdk/friendli" dark />
  </Tab>
  <Tab>
    <Snippet text="npm install @ai-sdk/friendli" dark />
  </Tab>
  <Tab>
    <Snippet text="yarn add @ai-sdk/friendli" dark />
  </Tab>
</Tabs>
...
You can create [FriendliAI models](https://friendli.ai/docs/guides/serverless_endpoints/text-generation#model-supports) using a provider instance.
...
If you use `@ai-sdk/friendli`, you can use the [built-in tools](https://friendli.ai/docs/guides/serverless_endpoints/tool-assisted-api#built-in-tools) via the `tools` option.
...
You can also use `@ai-sdk/openai-compatible` as the APIs are OpenAI-compatible.
