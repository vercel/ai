...
- **test_mode** _boolean_
  ...
  [HIPAA Unsupported] Only available for human transcriber option. When set to true, the behavior will mock a normal human transcription job except no transcription will happen.

- **segments_to_transcribe** _Array_

  [HIPAA Unsupported] Only available for human transcriber option. Use this option to specify which sections of the transcript need to be transcribed.

  - **start** _number_ - The timestamp of the beginning of the segment in seconds.
  - **end** _number_ - The timestamp of the end of the segment in seconds.

- **speaker_names** _Array_

  [HIPAA Unsupported] Only available for human transcriber option. Use this option to specify up to 100 names of speakers in the transcript.

  - **display_name** _string_ - The name of the speaker to be used when labeling monologues.
