...
<Note type="warning">
  [Azure OpenAI Responses API image generation
  tool](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/responses?tabs=python-secure#image-generation-preview)
  does not currently support streaming mode. You can not use the image tool with
  `streamText` currently.
</Note>
