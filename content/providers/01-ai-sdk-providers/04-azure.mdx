...
Keep the request-level `providerOptions.openai.reasoningEffort` unchanged throughout the conversation and
...
for continuation and configuration restrictions.
...
<Note>
  The 'web_search' tool is only supported with the default responses
