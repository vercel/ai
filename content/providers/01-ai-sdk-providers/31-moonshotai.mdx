...
The [Moonshot AI](https://www.moonshot.cn) provider offers access to powerful language models through the Moonshot API, including the Kimi series of models with reasoning capabilities.

API keys can be obtained from the [Moonshot Platform](https://platform.moonshot.cn).
...
<Note>
  Please see the [Moonshot AI docs](https://platform.moonshot.cn/docs/intro) for
