...
| ------------------------ | ------------------- | ----------------- | ---------- | -------------- |
| `moonshot-v1-8k`         | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `moonshot-v1-32k`        | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `moonshot-v1-128k`       | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `kimi-k2`                | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `kimi-k2.5`              | <Check />           | <Check />         | <Check />  | <Check />      |
| `kimi-k2-thinking`       | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `kimi-k2-thinking-turbo` | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `kimi-k2-turbo`          | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
