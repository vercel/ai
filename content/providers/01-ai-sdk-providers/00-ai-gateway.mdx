...
- **teamIdOrSlug** _string_
  ...
  Vercel team ID or slug used to scope requests when authenticating with
...
### Vercel Access Token Authentication

For dynamic runtime authentication, pass a Vercel personal access token or Vercel
app access token to a custom Gateway provider instance:
