...
You can query usage data programmatically using the [Advanced Reporting API](https://vercel.com/docs/ai-gateway/capabilities/advanced-reporting).

**Endpoint:** `GET https://ai-gateway.vercel.sh/v1/report`
...
| `tags`            | string |                                                       | Filter by tags (comma-separated, boolean OR)              |
