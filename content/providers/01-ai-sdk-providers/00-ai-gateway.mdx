...
The AI Gateway provider also accepts its own set of options. Refer to [AI Gateway provider options documentation](https://vercel.com/docs/ai-gateway/provider-options).
