...
You can generate images through AI Gateway with [`generateImage`](/docs/reference/ai-sdk-core/generate-image). Pass a model ID in `creator/model-name` format to `imageModel()`:
...
See the [Black Forest Labs image model documentation](/providers/ai-sdk-providers/black-forest-labs#image-models) for FLUX-specific inputs and options.

## Video Models

You can generate videos through AI Gateway with [`experimental_generateVideo`](/docs/reference/ai-sdk-core/generate-video). Pass a model ID in `creator/model-name` format to `videoModel()`:
...
AI Gateway polls the Black Forest Labs job until it completes. FLUX 3 supports
text-to-video, image-to-video, keyframes, video continuation, and audio
generation. See the [Black Forest Labs video model documentation](/providers/ai-sdk-providers/black-forest-labs#video-models) for model-specific inputs and options.
