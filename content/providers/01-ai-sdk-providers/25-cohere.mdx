...
You can create models that call the [Cohere chat API](https://docs.cohere.ai/api/#operation/createChatCompletion) using a provider instance.
...
You can create models that call the [Cohere embed API](https://docs.cohere.com/reference/embed)
