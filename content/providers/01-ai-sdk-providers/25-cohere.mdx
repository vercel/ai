...
| ----------------------------- | ------------------- | ------------------- | ------------------- | ------------------- |
| `command-a-03-2025`           | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-a-reasoning-08-2025` | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-a-vision-07-2025`    | <Check />           | <Check />           | <Check />           | <Check />           |
| `command-r7b-12-2024`         | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-r-plus-04-2024`      | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-r-plus`              | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-r-08-2024`           | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-r-03-2024`           | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
| `command-r`                   | <Cross size={18} /> | <Check />           | <Check />           | <Check />           |
