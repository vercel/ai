...
- **promptCacheRetention** _'in_memory' | '24h'_
  Controls how long cached prompt prefixes are retained, either in volatile GPU memory (in_memory) or for up to 24 hours using extended GPU-local storage (24h). Defaults to in_memory.
...
- **promptCacheRetention** _'in_memory' | '24h'_
  ...
  Controls how long cached prompt prefixes are retained, either in volatile GPU memory (in_memory) or for up to 24 hours using extended GPU-local storage (24h).
