...
Live supports **client delegation over server WebSockets and optional WebRTC**.
...
The [Realtime guide](/docs/ai-sdk-core/realtime) covers token-based Realtime sessions.
For Live capture, permission policy, lifecycle, and application-handled delegation,
see the [`experimental_useRealtime` reference](/docs/reference/ai-sdk-ui/use-realtime).
