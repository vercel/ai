...
Your application owns the agent and tool execution. Obtain server-only connection
...
The existing [Realtime guide](/docs/ai-sdk-core/realtime) covers token-based Realtime
sessions, not a Live hook integration. Live runtime and UI integration are not
included in this provider release.
