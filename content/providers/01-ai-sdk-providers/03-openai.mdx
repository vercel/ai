...
[Batch API](https://developers.openai.com/api/docs/guides/batch). Pass the OpenAI
provider to the AI SDK's [Text Batches](/docs/ai-sdk-core/text-batches) API for
