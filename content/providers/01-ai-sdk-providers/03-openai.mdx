...
The OpenAI provider supports text batches through the Responses API.
...
Creating a batch returns a serializable reference that can be persisted and used to retrieve the batch results later, or poll for status updates.
