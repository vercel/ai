...
const mask = fs.readFileSync('./mask.png'); // Transparent areas = edit regions
...
const cat = fs.readFileSync('./cat.png');
const dog = fs.readFileSync('./dog.png');
const owl = fs.readFileSync('./owl.png');
const bear = fs.readFileSync('./bear.png');
