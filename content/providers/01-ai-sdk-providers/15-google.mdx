...
conditional schemas, and negated schemas. Boolean `false` schemas also cannot be
represented without widening. Continue validating generated structured outputs
and tool inputs against the original schema.
