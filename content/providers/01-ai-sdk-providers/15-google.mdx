...
unsupported constraints and `oneOf` compatibility. Because the schema is not
rewritten in this fallback, unsupported-constraint warnings explain that the
keyword may not restrict values generated by the model rather than saying it
was removed.
