...
It uses Gemini structured output for Choice and Score questions. Choose a model
...
No probability distributions are synthesized, and Boolean questions are rejected
before a request because the adapter cannot supply their required probability of
true. See [Evaluation](/docs/ai-sdk-core/evaluation).
