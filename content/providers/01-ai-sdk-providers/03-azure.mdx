...
You can create models that call the [Azure OpenAI speech API](https://learn.microsoft.com/en-us/azure/ai-services/openai/text-to-speech-quickstart)
using the `.speech()` factory method.

The first argument is the model id e.g. `tts-1`.

```ts
const model = azure.speech('tts-1');
```
