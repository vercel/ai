...
xAI language models can also be used in the `streamText` functions (see [AI SDK
Core](/docs/ai-sdk-core)).
...
| ----------- | ------------------- | ------------------- | ------------------- | ------------------- |
| `grok-beta` | <Cross size={18} /> | <Cross size={18} /> | <Check size={18} /> | <Check size={18} /> |
