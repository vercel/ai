...
[LM Studio](https://lmstudio.ai/) is a local LLM server that you can use to run and test LLMs on your own hardware.
...
<Note>
  LM Studio uses port `1234` by default, but you can change in the [app's
  Developer tab](https://lmstudio.ai/docs/basics/server).
</Note>
