...
FriendliAI language models can also be used in the `streamText` function and support structured data generation with [`Output`](/docs/reference/ai-sdk-core/output)
...
| ----------------------------- | ------------------- | ----------------- | ------------------- | ------------------- |
| `deepseek-r1`                 | <Cross size={18} /> | <Check />         | <Cross size={18} /> | <Cross size={18} /> |
| `meta-llama-3.3-70b-instruct` | <Cross size={18} /> | <Check />         | <Check />           | <Check />           |
| `meta-llama-3.1-8b-instruct`  | <Cross size={18} /> | <Check />         | <Check />           | <Check />           |
