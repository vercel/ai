...
| --------------------- | ------------------------------------------------------------------- | --------- | ------------------- | ---------- | ------------------------- |
| `qwen/qwen3-32b-awq`  | 32B parameter multilingual model with strong reasoning capabilities | <Check /> | <Cross size={18} /> | <Check />  | Standard reasoning events |
| `openai/gpt-oss-120b` | 120B parameter open-source GPT model                                | <Check /> | <Cross size={18} /> | <Check />  | Standard reasoning events |
...
Using [`Output`](/docs/reference/ai-sdk-core/output) to enforce structured output is not supported by two models that are part of this provider.
