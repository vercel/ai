...
The same provider handles text generation, streaming, tool calls, structured output, and image input. Model requests stay within the Neon branch, and short IDs such as `gpt-5-mini` and `gemini-2-5-flash` work across providers.
