...
models (GLM 5.3, GLM 5.3 Flash, DeepSeek V4.1 Flash) with up to 1M-token context and free
...
Flash), and `deepseek-v4.1-flash-fast-fp4` (DeepSeek V4.1 Flash). The id type is open, so a
