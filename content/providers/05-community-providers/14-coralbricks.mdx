...
models (GLM 5.3, GLM 5.3 Flash, DeepSeek V4.1 Flash, GPT-OSS 120B) with up to 1M-token context and free
...
Flash), `deepseek-v4.1-flash-fast-fp4` (DeepSeek V4.1 Flash), and `gpt-oss-120b`. The id type is open, so a
