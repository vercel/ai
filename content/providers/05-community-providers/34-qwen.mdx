...
Qwen language models can also be used in the `streamText` function and support structured data generation with [`Output`](/docs/reference/ai-sdk-core/output)
...
| `qwen-plus-latest`        | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `qwen-max`                | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `qwen2.5-72b-instruct`    | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
| `qwen2.5-14b-instruct-1m` | <Cross size={18} /> | <Check />         | <Check />  | <Check />      |
