...
Use Arize AX when you want a managed production platform for AI SDK tracing, monitoring, and evaluation. If you prefer an open-source local or self-hosted workflow, use [Arize Phoenix](https://arize.com/docs/phoenix).
...
- Review Arize's [agent evaluation](https://arize.com/guides/ai-agent-handbook/agent-evaluation/) and [LLM evaluation](https://arize.com/resources/llm-evaluation/) guides for broader evaluation patterns
