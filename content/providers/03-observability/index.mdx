...
There are also tools that record the AI SDK's provider traffic without instrumentation, and can replay a run offline:

- [OrcaReplay](/providers/observability/orcareplay)
