---
title: Fireworks.ai
description: Learn how to use Fireworks.ai with the AI SDK.
---
...
The AI SDK provides a set of utilities to make it easy to use [Fireworks.ai](https://app.fireworks.ai)'s APIs and models. In this guide, we'll walk through how to use the utilities to create a chat bot and a text completion app.
...
Create a Next.js application and install `ai` and `openai`, the AI SDK and OpenAI API client respectively. Fireworks' REST APIs [are compatible with OpenAI](https://readme.fireworks.ai/docs/getting-started-with-your-api#openai-python-client-library)'s so we will use OpenAI's JavaScript SDK to make the requests.
