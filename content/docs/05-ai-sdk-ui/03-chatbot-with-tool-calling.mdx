...
<Note>
  ...
  calls are server-side, you need to set [`maxToolRoundtrips`](/docs/reference/ai-sdk-ui/use-chat#max-automatic-roundtrips) to a value greater
...
3. The [`maxToolRoundtrips`](/docs/reference/ai-sdk-ui/use-chat#max-automatic-roundtrips) option is set to 5.
