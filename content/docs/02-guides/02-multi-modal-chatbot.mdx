...
In this guide, you will build a mult-modal AI-chatbot with a streaming user interface.
...
Update your root page (`app/page.tsx`) to with the following code:
...
You've built a multi-modal AI chatbot using the Vercel AI SDK! Experiment and extend the functionality of this application further by exploring [tool calling](/docs/ai-sdk-core/tools-and-tool-calling) or introducing more granular control over [AI and UI states](/docs/ai-sdk-rsc/generative-ui-state).
