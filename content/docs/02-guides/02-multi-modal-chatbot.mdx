...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    <Tab>
      <Snippet
        text="pnpm add ai@alpha @ai-sdk/react@alpha @ai-sdk/openai@alpha"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="npm install ai@alpha @ai-sdk/react@alpha @ai-sdk/openai@alpha"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="yarn add ai@alpha @ai-sdk/react@alpha @ai-sdk/openai@alpha"
        dark
      />
    </Tab>
  </Tabs>
