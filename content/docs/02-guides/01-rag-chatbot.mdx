...
description: Learn how to build a RAG Chatbot with the Vercel AI SDK and Next.js
---
...
To reduce the scope of this guide, you will be starting with a [repository](https://github.com/vercel-labs/ai-sdk-rag-starter) that already has a few things set up for you:
...
<Snippet
  text={[
    'git clone https://github.com/vercel-labs/ai-sdk-rag-starter',
...
Great! Let's bulid the frontend. Vercel AI SDK’s [`useChat`](/docs/reference/ai-sdk-ui/use-chat) hook allows you to easily create a conversational user interface for your chatbot application.
