...
<Note>
  To use o3-mini, you must be using @ai-sdk/openai version 1.1.8 or greater.
</Note>

AI SDK Core abstracts away the differences between model providers, allowing you to focus on building great applications.
