...
Anthropic adapt structured language-model output for Choice and Score. Their
answers do not include
probability distributions, and Boolean questions are unsupported. Select a model
that supports the provider's structured-output API; judge quality against your
