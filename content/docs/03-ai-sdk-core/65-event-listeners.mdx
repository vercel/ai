...
const result = await generateText({
  ...
  onEnd: event => {
    console.log('Generation finished:', event.usage);
  },
});
```
...
<PropertiesTable
  content={[
    ...
    },
    {
      name: 'instructions',
      type: 'Instructions | undefined',
      description: 'The instructions provided to the model for this step.',
    },
    {
      name: 'messages',
      type: 'Array<ModelMessage>',
...
<PropertiesTable
  content={[
    ...
    },
    {
      name: 'responseId',
      type: 'string',
      description: 'The provider-returned response ID for this model call.',
    },
    {
      name: 'performance',
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                'Timing statistics for the gaps between streamed output-token chunks in milliseconds. Only available for streaming model calls with at least two output-token chunks.',
            },
          ],
        },
      ],
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'OutputTokenTimingStats | undefined',
              description:
                'Timing statistics for the gaps between streamed output-token chunks in milliseconds. Only available for streaming steps with at least two output-token chunks.',
            },
          ],
        },
      ],
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'CONTEXT',
      description:
        'Deprecated. Use `finalStep.runtimeContext` instead. The final state of the user-defined shared runtime context object.',
    },
    {
      name: 'toolsContext',
      type: 'InferToolSetContext<TOOLS>',
