...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'CONTEXT',
      description:
        'User-defined runtime context object that flows through the entire generation lifecycle.',
    },
  ]}
/>
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'CONTEXT',
      description:
        'User-defined runtime context object. May be updated from prepareStep between steps.',
    },
  ]}
/>
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'CONTEXT',
      description:
        'User-defined runtime context object flowing through the generation.',
    },
  ]}
/>
...
<PropertiesTable
  content={[
    ...
    },
    {
      name: 'context',
      type: 'CONTEXT',
      description: 'The final state of the user-defined runtime context object.',
    },
    {
      name: 'providerMetadata',
      type: 'ProviderMetadata | undefined',
