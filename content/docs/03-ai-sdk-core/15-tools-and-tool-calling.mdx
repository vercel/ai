...
The AI SDK provides several helper types to make working with tools easier.
...
The type inference helpers `ToolCallUnion<TOOLS extends Record<string, CoreTool>>`
and `ToolResultUnion<TOOLS extends Record<string, CoreTool>>` can be used to
