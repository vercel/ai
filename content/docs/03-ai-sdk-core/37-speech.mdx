...
For Gemini 3.8 dialogue, provide the transcript in
`providerOptions.google.turns` and pass `text: ''`. Each turn supplies its own
speaker and optional delivery style. See [Google speech models](/providers/ai-sdk-providers/google#multi-speaker-audio)
