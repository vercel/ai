...
includes a mock providers and test helpers that you can use to test your code.

You can import the following helpers from `ai/test`:
...
- `mockId`: Provides an increase integer ID.
...
You can use the test helpers with the AI Core functions:
