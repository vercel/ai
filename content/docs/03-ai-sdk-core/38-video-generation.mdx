...
const { video } = await generateVideo({
  model: fal.video('fal-ai/luma-dream-machine'),
...
const { video } = await generateVideo({
  ...
  prompt: {
    files: ['https://example.com/my-image.png'],
    text: 'Animate this image with gentle motion',
  },
});
```

You can also provide images as base64-encoded strings or `Uint8Array`:

```tsx
const { video } = await generateVideo({
  model: fal.video('fal-ai/stable-video-diffusion'),
  prompt: {
    files: [imageBase64String], // or imageUint8Array
...
| ----------------------------------------------------------------------- | ------------------------------------- | -------------------------------------- |
| [FAL](/providers/ai-sdk-providers/fal#video-models)                     | `fal-ai/luma-dream-machine`           | Text-to-video, image-to-video          |
| [FAL](/providers/ai-sdk-providers/fal#video-models)                     | `fal-ai/minimax-video`                | Text-to-video                          |
| [FAL](/providers/ai-sdk-providers/fal#video-models)                     | `fal-ai/stable-video-diffusion`       | Image-to-video                         |
...
| [Replicate](/providers/ai-sdk-providers/replicate#video-models)         | `stability-ai/stable-video-diffusion` | Image-to-video                         |
