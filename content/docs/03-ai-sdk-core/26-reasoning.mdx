...
| Value                | Behavior                                                                       |
| -------------------- | ------------------------------------------------------------------------------ |
| `'provider-default'` | Use the provider's default reasoning behavior (same as omitting the parameter) |
...
When omitted, the provider's default behavior applies. Providers that do not support reasoning emit a warning and ignore the parameter.
