...
<IndexCards
  cards={[
    ...
    {
      title: 'Agents',
      description: 'Learn how to use agents with the Vercel AI SDK Core.',
    ...
    {
      title: 'Middleware',
      description: 'Learn how to use middleware with the Vercel AI SDK Core.',
      href: '/docs/ai-sdk-core/middleware',
    },
    {
      title: 'Error Handling',
      description: 'Learn how to handle errors with the Vercel AI SDK Core.',
      href: '/docs/ai-sdk-core/error-handling',
    },
    {
      title: 'Testing',
      description: 'Learn how to test with the Vercel AI SDK Core.',
      href: '/docs/ai-sdk-core/testing',
    },
    {
      title: 'Telemetry',
      description: 'Learn how to use telemetry with the Vercel AI SDK Core.',
