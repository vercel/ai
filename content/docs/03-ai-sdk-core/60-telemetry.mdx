...
- `ai.toolCall.input`: the input parameters of the tool call
- `ai.toolCall.output`: the output result of the tool call. Only available if the tool call is successful and the result is serializable.
