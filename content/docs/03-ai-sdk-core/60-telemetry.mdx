...
`aisdk.telemetry` [tracing channel](https://nodejs.org/api/diagnostics_channel.html#diagnostics_channeltracingchannelnameorchannels).
...
registered integrations and tracing-channel publication for that call.
