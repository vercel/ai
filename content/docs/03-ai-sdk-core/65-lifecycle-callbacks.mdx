...
<PropertiesTable
  content={[
    ...
    },
    {
      name: 'operationId',
      type: 'string',
      description: "Operation type, such as 'ai.generateText' or 'ai.streamText'.",
    },
    {
      name: 'provider',
      type: 'string',
...
<PropertiesTable
  content={[
    ...
    },
    {
      name: 'toolCall',
      type: 'TypedToolCall',
      description: 'The tool call that is about to execute, including `toolCallId`, `toolName`, and `input`.',
    },
    {
      name: 'messages',
      type: 'Array<ModelMessage>',
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Discriminated union representing either a successful tool result or a tool error.',
    },
  ]}
/>
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Request metadata, including request body and request messages when included.',
    },
    {
      name: 'response',
      type: 'LanguageModelResponseMetadata',
      description: 'Response metadata, including response headers, body, and messages when included.',
    },
    {
      name: 'runtimeContext',
      type: 'CONTEXT',
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Response data. For `embedMany`, this can be one response per chunk.',
    },
  ]}
/>
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Reranked results sorted by relevance score in descending order.',
    },
    {
      name: 'warnings',
      type: 'Array<Warning>',
