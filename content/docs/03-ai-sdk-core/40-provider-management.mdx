...
You can list all models in the custom provider along with their capabilities.
...
const provider = customProvider({
  ...
  textEmbeddingModels: {
    'text-embedding-3-small': originalOpenAI.textEmbeddingModel('text-embedding-3-small'),
  },
  imageModels: {
    'dall-e-3': originalOpenAI.imageModel('dall-e-3'),
  },
});
...
### Example: list providers and models

You can list all providers and their supported models.
