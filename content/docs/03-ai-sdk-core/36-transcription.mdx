...
- `responses`: Metadata about the transcription model responses, including timestamp, model, headers, and body when available.
- `providerMetadata`: Provider-specific metadata reported by the model.
