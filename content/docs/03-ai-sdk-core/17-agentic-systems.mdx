...
description: Learn about creating agentic systems with AI SDK Core.
---
...
### Tool Usage
Enhanced capabilities through tool interfaces (like calculators, APIs, or databases) that the LLM can use to accomplish tasks. Tools provide a controlled way to extend what the LLM can do.
