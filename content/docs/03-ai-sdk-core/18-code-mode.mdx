...
When continuing the conversation in a later generation call, append
`result.experimental_continuationMessages` to your input history. It includes
the capability catalog as well as the assistant and tool response messages.
