...
description: Learn how to implement sequential generations ("chains") with the Vercel AI SDK

---
# Sequential Generations
When working with the Vercel AI SDK, you may want to create sequences of generations ("chains"), where the output of one becomes the input for the next. This can be useful for creating more complex AI-powered workflows or for breaking down larger tasks into smaller, more manageable steps.
