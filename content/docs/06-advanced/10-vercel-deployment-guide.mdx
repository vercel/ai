...
This guide will teach you how to deploy the application you built in the Next.js (App Router) quickstart tutorial to Vercel. If you haven’t completed the quickstart guide, you can start with [this repo](https://github.com/nicoalbanese/ai-sdk-deployment-guide).
...
You can increase the max duration to 60 seconds on the Hobby Tier.
