...
The integrations (other than RSC) have moved to separate Node modules. You need to update the import and require statements as follows:

- Change `ai/react` to `@ai-sdk/react`
