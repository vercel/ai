...
<Note>
  The model registry is not available any more. Please register providers
  instead.
</Note>
...
<Note>
  The model registry is not available any more. Please [register providers](/docs/reference/ai-sdk-core/provider-registry#setup)
  instead.
</Note>
