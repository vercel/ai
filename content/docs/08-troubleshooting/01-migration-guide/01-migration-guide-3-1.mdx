...
description: Learn how to migrate from AI SDK 3.0 to 3.1.
---
...
Upgrading to AI SDK 3.1 does not require using the newly released AI SDK Core API or [`streamUI`](/docs/reference/ai-sdk-rsc/stream-ui) function. You can continue to use the AI SDK with [existing (Legacy) providers](/providers/legacy-providers).
