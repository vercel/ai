---
title: Migrate 3.0 to 3.1
description: Learn how to migrate from the AI SDK 3.0 to 3.1.
---
...
- Upgrade to the AI SDK 3.1
- Migrate from [Legacy Providers](/providers/legacy-providers) to AI SDK Core
- Migrate from [`render`](/docs/reference/ai-sdk-rsc/render) to [`streamUI`](/docs/reference/ai-sdk-rsc/stream-ui)

Upgrading to the AI SDK 3.1 does not require using the newly released AI SDK Core API or [`streamUI`](/docs/reference/ai-sdk-rsc/stream-ui) function. You can continue to use the AI SDK with [existing (Legacy) providers](/providers/legacy-providers).
