...
- [Tensormesh Provider](/providers/community-providers/tensormesh) (`@tensormesh/ai-sdk-provider`)
...
| -------------------------------------------------- | ------------------------------------------- | ----------- | ----------------- | ---------- | -------------- |
| [xAI Grok](/providers/ai-sdk-providers/xai)        | `grok-4.7`                                  | <Check />   | <Check />         | <Check />  | <Check />      |
