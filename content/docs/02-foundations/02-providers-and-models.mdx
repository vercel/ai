...
| [Google Generative AI](/providers/ai-sdk-providers/google-generative-ai) | `models/gemini-1.5-flash-latest` | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> | <Check size={18} /> |
