...
The default download implementation automatically downloads files when they are not supported by the model.

You can use it to implement throttling, retries, authentication, caching, and more.
