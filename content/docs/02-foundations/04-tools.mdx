...
- **[Awesome MCP Registry](https://github.com/toolsdk-ai/awesome-mcp-registry)** - An open, high-quality, well-structured and developer-friendly list of 4081+ MCP servers. - [Tool SDK](https://toolsdk.ai)
- **[Tool SDK](https://github.com/toolsdk-ai/toolsdk)** - 5000+ MCP Servers & AI Tools, 1 Line of Code - [Tool SDK](https://toolsdk.ai)
