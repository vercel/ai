...
- **[AWS Bedrock AgentCore built-in tools](https://github.com/aws/bedrock-agentcore-sdk-typescript)** - Fully managed [Code Interpreter and Browser](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/built-in-tools.html) tools in isolated environments with zero infrastructure management.
