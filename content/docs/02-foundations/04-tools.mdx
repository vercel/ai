...
- **[arcade](https://github.com/ArcadeAI/arcade-ai)** - The foundation for secure agentic tools.  Client libraries to connect to our pre-made tools and the development kits and runtime to build and run your own... with the auth, secrets, and user-managment you need to get your agents to prod. 
