...
- **[fmp-ai-tools](https://fmp-node-wrapper-docs.vercel.app/docs/tools/vercel-ai)** - Financial data toolkit powered by Financial Modeling Prep API, providing access to real-time stock quotes, company profiles, financial statements, market news, and technical indicators for AI-powered financial analysis and decision-making.
