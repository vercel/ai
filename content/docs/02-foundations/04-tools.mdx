...
- **[AWS Bedrock AgentCore built-in tools](https://github.com/aws/bedrock-agentcore-sdk-typescript)** - Fully managed [code execution (Python, TypeScript, JavaScript) and browser](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/built-in-tools.html) in isolated environments with zero infrastructure management.
