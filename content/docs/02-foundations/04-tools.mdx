...
- **[Arcade](https://docs.arcade.dev/home/vercelai/use-arcade-tools)** - An AI tool-calling platform with secure, authenticated integrations (LinkedIn, Gmail, Slack, Github, X, and [more](https://docs.arcade.dev/toolkits)).
