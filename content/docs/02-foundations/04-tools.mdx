...
- **[@brightdata/ai-sdk](https://www.npmjs.com/package/@brightdata/ai-sdk)** - Give agents unrestricted access to the live web - search, extract, and navigate any site, unblocked.
