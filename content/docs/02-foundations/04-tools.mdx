...
- **[Awesome MCP Registry](https://github.com/toolsdk-ai/awesome-mcp-registry)** – A searchable registry with self-hosted API to help Vercel AI SDK users quickly find tools.
