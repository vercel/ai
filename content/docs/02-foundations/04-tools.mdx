...
- **[SearchMCP](https://searchmcp.io/docs/integrations/vercel-ai-sdk)** – Real-time Google search (web, images, news, shopping, videos) for AI agents and LLMs via REST and MCP.
