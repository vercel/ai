...
- **[@valyu/ai-sdk](https://www.npmjs.com/package/@valyu/ai-sdk)** - Web search and specialized domain-specific search tools (finance, academic papers, biomedical, patents, SEC filings, economics) for AI agents.
