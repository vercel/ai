...
- [DeepAgents](/providers/ai-sdk-harnesses/deepagents) (`@ai-sdk/harness-deepagents`)
...
| [DeepAgents](/providers/ai-sdk-harnesses/deepagents)   | Sandbox bridge   | <Check size={18} /> | <Check size={18} /> | <Cross size={18} />    |
