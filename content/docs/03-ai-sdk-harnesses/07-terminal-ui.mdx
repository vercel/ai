...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
    <Tab>
      <Snippet
        text="pnpm add @ai-sdk/tui@canary @ai-sdk/harness@canary @ai-sdk/harness-codex@canary @ai-sdk/sandbox-vercel@canary"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="npm install @ai-sdk/tui@canary @ai-sdk/harness@canary @ai-sdk/harness-codex@canary @ai-sdk/sandbox-vercel@canary"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="yarn add @ai-sdk/tui@canary @ai-sdk/harness@canary @ai-sdk/harness-codex@canary @ai-sdk/sandbox-vercel@canary"
        dark
      />
    </Tab>
    <Tab>
      <Snippet
        text="bun add @ai-sdk/tui@canary @ai-sdk/harness@canary @ai-sdk/harness-codex@canary @ai-sdk/sandbox-vercel@canary"
        dark
      />
    </Tab>
  </Tabs>
