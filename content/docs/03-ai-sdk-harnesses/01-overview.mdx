...
reasoning, streaming tool input, tool calls, tool results, usage, and finish
reasons use the same AI SDK shapes where possible. Events without a first-class AI SDK part, such as
