...
With AI SDK UI, `useChat` comes with built-in support for parallel tool calls. You can define multiple tools in the `useChat` hook and have them called them in parallel.
