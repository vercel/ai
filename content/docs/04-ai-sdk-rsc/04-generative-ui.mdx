...
description: Overview of generative user interfaces
---

# Generative User Interfaces

Generative user interfaces elevate language models beyond plaintext and markdown. By rendering dynamic, adaptive user interfaces, language models can proactively adapt to the needs of the user. 

Built for use with React Server Components, `ai/rsc` is optimized for delivering highly-dynamic, personalized software like an e-commerce store, a web app, a social network -- and the most dynamic interfaces of them all: generative user interfaces. The benefits of using React Server Components for generative user interfaces include:

- Reduced client bundle sizes
- Fewer round trips between the server and the client
- Improved developer experience around managing backend and frontend code 

<div className="mb-4">
  <Note>
    {' '}
    Generative user interfaces are still possible without the use of React Server Components.
  </Note>
</div>
