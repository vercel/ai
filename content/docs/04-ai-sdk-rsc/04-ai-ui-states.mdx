...
To start, you need create a React context using [`createAI`](/docs/reference/ai-sdk-rsc/create-ai), and wrap your application with it. Then, the AI and UI states will be available to all its children:
