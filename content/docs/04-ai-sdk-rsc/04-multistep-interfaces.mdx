...
- a tool(s) (think sub-tasks necessary to complete your overall task)
- a React component(s) that should be rendered when the tool is called
- a page to render your chatbot

The general flow that you will follow is the following:
...
To call this Server Action, update your root page with the following:
