...
- **No major breaking changes** - the core architecture is stable
- **Minor breaking changes possible** - we may refine APIs based on your feedback
- **Regular bug fixes and improvements** - active development continues
- **Pin your versions** - use exact version numbers to avoid unexpected changes

Your feedback during this beta phase directly shapes the final stable release. Share your experiences through [GitHub issues](https://github.com/vercel/ai/issues/new/choose) or [discussions](https://github.com/vercel/ai/discussions).
...
npm install ai@beta @ai-sdk/[your_provider]@beta @ai-sdk/[your_framework]@beta
```
...
AI SDK 5 is a complete redesign of the AI SDK's protocol and architecture based on everything we learned over the last two years of real-world usage. We also modernized the UI and protocols that have remained largely unchanged since AI SDK v2/3, creating a strong foundation for the future.
...
While we designed AI SDK 5 to be a substantial improvement over previous versions, we're still in active development. You might encounter bugs or unexpected behavior. We appreciate your feedback and bug reports—they're essential to making this release better. Share your experiences and suggestions with us through [GitHub issues](https://github.com/vercel/ai/issues/new/choose) or [GitHub discussions](https://github.com/vercel/ai/discussions).
...
Ready to upgrade from AI SDK 4.x to 5.0? We created a comprehensive migration guide to help you through the process.
...
- Enhanced streaming protocol with Server-Sent Events
...
- Automated codemods to transform your code
- Detailed examples for each breaking change
- Best practices for adopting new features

For a smooth transition, use the provided codemods and follow the recommended migration process outlined in the guide.
