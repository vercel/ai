---
title: Workflows
description: Learn different workflow patterns for building Agents with the AI SDK.
---

# Workflows

The building blocks described in [building agentic systems](/docs/agents/building-agentic-systems) can be combined with workflow patterns to help introduce structure and reliability to your agents:
