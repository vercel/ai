...
### Use the Zod v3 Import Path

The recommended solution is to import Zod using the v3-specific import path:

```typescript
// ❌ Avoid: Standard import causes TypeScript issues
import { z } from 'zod';

// ✅ Use: v3-specific import for AI SDK 5 compatibility
