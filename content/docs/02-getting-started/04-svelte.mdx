...
```tsx filename="src/routes/api/chat/+server.ts" highlight="2,3,19-33"
import {
  createGateway,
  streamText,
  type UIMessage,
...
```ts filename="src/routes/api/chat/+server.ts" highlight="17"
import {
  createGateway,
  streamText,
  type UIMessage,
...
```tsx filename="src/routes/api/chat/+server.ts" highlight="34-47"
import {
  createGateway,
  streamText,
  type UIMessage,
