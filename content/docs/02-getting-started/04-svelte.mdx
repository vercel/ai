...
<div className="my-4">
  <Tabs items={['pnpm', 'npm', 'yarn']}>
    <Tab>
      <Snippet text="pnpm add -D ai@alpha @ai-sdk/openai@alpha @ai-sdk/svelte@alpha zod" dark />
    </Tab>
    <Tab>
      <Snippet
        text="npm install -D ai@alpha @ai-sdk/openai@alpha @ai-sdk/svelte@alpha zod"
        dark
      />
    </Tab>
    <Tab>
      <Snippet text="yarn add -D ai@alpha @ai-sdk/openai@alpha @ai-sdk/svelte@alpha zod" dark />
    </Tab>
  </Tabs>
</div>
