...
The [Vercel AI Gateway](/providers/ai-sdk-providers/ai-gateway) is the simplest way to get started with the AI SDK. Access models from OpenAI, Anthropic, Google, and other providers with a single API key.
