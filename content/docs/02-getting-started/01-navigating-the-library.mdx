...
| --------------------- | ----------------------------------------- | ------------------------------------- | --------------------------------------- |
| None / Node.js / Deno | <Check />                                 | <Cross size={18} />                   | <Cross size={18} />                     |
| Vue / Nuxt            | <Check />                                 | <Check />                             | <Cross size={18} />                     |
| Svelte / SvelteKit    | <Check />                                 | <Check />                             | <Cross size={18} />                     |
| Next.js Pages Router  | <Check />                                 | <Check />                             | <Cross size={18} />                     |
...
| [useChat](/docs/reference/ai-sdk-ui/use-chat) tool calling | <Check /> | <Check />           | <Cross size={18} /> |
| [useCompletion](/docs/reference/ai-sdk-ui/use-completion)  | <Check /> | <Check />           | <Check />           |
| [useObject](/docs/reference/ai-sdk-ui/use-object)          | <Check /> | <Cross size={18} /> | <Cross size={18} /> |
| [MCP Apps](/docs/ai-sdk-core/mcp-apps)                     | <Check /> | <Cross size={18} /> | <Cross size={18} /> |
