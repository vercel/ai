...
and WSS URLs. React and Vue chat hooks close replaced transports and close the
current transport on unmount or scope disposal. Call `chat.dispose()` when you
manage a framework `Chat` instance directly.
