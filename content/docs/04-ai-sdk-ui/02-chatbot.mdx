...
These tokens are typically send before the message content.
You can enable forwarding them to the client with the `sendReasoning` option:
...
On the client side, you can access the reasoning text in the `reasoning` property of the message object:
