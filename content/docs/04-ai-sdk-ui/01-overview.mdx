...
| Vue.js `@ai-sdk/vue`                                            | <Check />                                     | <Check />                                                 | <Check />                                         | <Cross size={18} />                    |
| Svelte `@ai-sdk/svelte`                                         | <Check /> Chat                                | <Check /> Completion                                      | <Check /> StructuredObject                        | <Cross size={18} />                    |
| Angular `@ai-sdk/angular`                                       | <Check /> Chat                                | <Check /> Completion                                      | <Check /> StructuredObject                        | <Cross size={18} />                    |
| [SolidJS](https://github.com/kodehort/ai-sdk-solid) (community) | <Check />                                     | <Check />                                                 | <Check />                                         | <Cross size={18} />                    |
