...
`onFinish` receives the messages from the frontend and backend as `UIMessage[]`.
...
```tsx filename="ui/chat.tsx" highlight="8-14"
...
To achieve this, you can provide an `prepareRequestBody` function to the `useChat` hook.
