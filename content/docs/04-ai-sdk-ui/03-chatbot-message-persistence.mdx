...
```tsx filename="app/api/chat/route.ts" highlight="12-18"
import {
  createIdGenerator,
  createUIMessageStreamResponse,
  streamText,
...
```tsx filename="app/api/chat/route.ts" highlight="8-17,20-24"
import {
  convertToModelMessages,
  createUIMessageStreamResponse,
  toUIMessageStream,
...
```tsx filename="app/api/chat/route.ts" highlight="27-29"
import {
  convertToModelMessages,
  createUIMessageStreamResponse,
  streamText,
