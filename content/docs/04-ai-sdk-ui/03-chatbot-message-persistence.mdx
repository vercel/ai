...
You can control the ID format by providing ID generators (see [`createIdGenerator()`](/docs/reference/ai-sdk-core/create-id-generator) and [`generateId()`](/docs/reference/ai-sdk-core/generate-id)):
