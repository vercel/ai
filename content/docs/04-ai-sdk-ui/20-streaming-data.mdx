...
- **Tool Execution Status** - Show which server-side tool is currently running via transient parts (see [Reacting to server-executed tools](/docs/ai-sdk-ui/chatbot-tool-usage#reacting-to-server-executed-tools))
