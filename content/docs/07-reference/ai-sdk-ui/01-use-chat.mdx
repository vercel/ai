      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              isOptional: true,
              description: 'Additional annotations sent along with the message.',
            },
            {
              name: 'experimental_attachments',
              type: 'Array<Attachment>',
              isOptional: true,
              description: 'Additional attachments sent along with the message.',
              properties: [
                {
                  type: 'Attachment',
                  parameters: [
                    ...
                    },
                    {
                      ...
                      type: "string",
                      isOptional: true,
                      description: "A string indicating the media type of the file."
                    },
                    {
                      name: 'data',
                      type: 'string',
                      isOptional: true,
                      description: 'The URL of the attachment. It can either be a URL to a hosted file or a Data URL.',
                    },
                  ],
                },
              ],
