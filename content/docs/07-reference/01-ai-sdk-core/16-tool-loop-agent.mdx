...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Callback that is called for each chunk of the stream. If also specified in `stream()`, both callbacks are called (constructor first).',
    },
    {
      name: 'onError',
      ...
      isOptional: true,
      description:
        'Callback that is called when an error occurs during streaming. If also specified in `stream()`, both callbacks are called (constructor first).',
    },
    {
      name: 'onAbort',
      ...
      isOptional: true,
      description:
        'Callback that is called when the stream is aborted. If also specified in `stream()`, both callbacks are called (constructor first).',
    },
    {
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Callback that is called for each chunk of the stream. If also specified in the constructor, both callbacks are called (constructor first).',
    },
    {
      name: 'onError',
      type: 'StreamTextOnErrorCallback',
      isOptional: true,
      description:
        'Callback that is called when an error occurs during streaming. If also specified in the constructor, both callbacks are called (constructor first).',
    },
    {
      name: 'onAbort',
      type: 'StreamTextOnAbortCallback',
      isOptional: true,
      description:
        'Callback that is called when the stream is aborted. If also specified in the constructor, both callbacks are called (constructor first).',
    },
    {
      name: 'experimental_onStart',
      type: 'GenerateTextOnStartCallback',
