...
<PropertiesTable
  content={[
    ...
    {
      name: 'maxDownloadSizeInBytes',
      type: 'number',
      isOptional: true,
      description:
        'Maximum allowed download size in bytes when audio is a URL. Prevents DoS attacks via unbounded memory consumption. Default: 100MB (104857600 bytes).',
    },
  ]}
/>
