              ...
              properties: [
                {
                  ...
                  parameters: [
                    ...
                    },
                    {
                      ...
                      isOptional: true,
                      description:
                        'The sandbox environment passed via the `sandbox` setting.',
                    },
                  ],
                },
              ],
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            {
              name: 'performance',
              type: '{ responseTimeMs: number; tokensPerSecond: number; timeToFirstTokenMs: number | undefined }',
              ...
              properties: [
                {
                  ...
                  parameters: [
                    ...
                    },
                    {
                      ...
                      type: 'number',
                      description:
                        'Average number of output tokens per second during the language model response.',
                    },
                    {
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                'Timing and throughput metrics for the step. For `generateText`, `timeToFirstTokenMs` is undefined.',
              properties: [
                {
                  type: 'StepResultPerformance',
                  parameters: [
                    {
                      ...
                      type: 'number',
                      description:
                        'Average number of output tokens per second for the language model response.',
                    },
                    {
                      name: 'stepTimeMs',
                      type: 'number',
                    ...
                    {
                      name: 'maxToolExecutionMs',
                      type: 'number',
                      description:
                        'Maximum time spent executing a single client-side tool in the step in milliseconds.',
                    },
                    {
                      name: 'timeToFirstTokenMs',
                      type: 'number | undefined',
