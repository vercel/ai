      ...
      properties: [
        {
          ...
          parameters: [
            ...
            {
              name: 'invalidToolCalls',
              type: 'Array<InvalidToolCall>',
              description:
                'The invalid tool calls from this step (tool not found or bad input).',
            },
            {
              name: 'toolResults',
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'Array<InvalidToolCall>',
              description:
                'The invalid tool calls from the final step (tool not found or bad input).',
            },
            {
              name: 'toolResults',
              type: 'Array<TypedToolResult<TOOLS>>',
