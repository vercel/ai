...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'string',
      description:
        'The concatenation of all text parts generated in the last step. It is an empty string if the last step contains no text parts. Inspect `content` to distinguish that case.',
    },
    {
      name: 'reasoning',
