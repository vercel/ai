...
<PropertiesTable
  content={[
    ...
    {
      name: 'experimental_retention',
      type: 'RetentionSettings',
      isOptional: true,
      description:
        'Controls retention of request and response bodies in step results. By default, bodies are retained. When processing many large payloads (e.g., images), set requestBody and/or responseBody to false to reduce memory usage. Experimental feature.',
      properties: [
        {
          type: 'RetentionSettings',
          parameters: [
            {
              ...
              isOptional: true,
              description:
                'Whether to retain the request body in step results. The request body can be large when sending images or files. Default: true.',
            },
            {
              name: 'responseBody',
              type: 'boolean',
              isOptional: true,
              description:
                'Whether to retain the response body in step results. Default: true.',
            },
          ],
        },
      ],
