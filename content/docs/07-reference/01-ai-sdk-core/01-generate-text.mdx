  ...
  content={[
    {
      name: 'model',
      type: 'LanguageModel',
      description: "The language model to use. Example: openai('gpt-6-astra')",
    },
    {
      name: 'instructions',
      type: 'Instructions',
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'string',
              description:
                'The specific model identifier (e.g., "gpt-6-astra").',
            },
            {
              name: 'instructions',
              type: 'Instructions | undefined',
