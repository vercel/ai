...
<PropertiesTable
  content={[
              ...
              properties: [
                {
                  ...
                  parameters: [
                    ...
                    },
                    {
                      ...
                      isOptional: true,
                      description:
                        'The context passed via the `context` setting.',
                    },
                  ],
                },
              ],
        ...
        },
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              isOptional: true,
              description:
                'Context that is passed into tool execution. Changing the context will affect the context in this step and all subsequent steps.',
            },
            {
              name: 'providerOptions',
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'User-defined context object passed to `prepareStep`, tool execution, and lifecycle callbacks.',
    },
    {
