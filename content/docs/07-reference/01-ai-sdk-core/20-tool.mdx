      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'boolean',
              description:
                "Keep this tool out of the model context until toolSearch discovers it. Requires exclusive routing through code mode with toolDiscovery: 'conversation'. Discovered tools become available on the next model step. Defaults to false.",
            },
            {
              name: 'title',
              isOptional: true,
