      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                'Top-level context properties that contain sensitive data and should be excluded from telemetry. Properties marked as `true` are omitted from telemetry integrations. Tool execution, lifecycle callbacks, and returned results still receive the full tool context.',
            },
            {
              name: 'strict',
              isOptional: true,
