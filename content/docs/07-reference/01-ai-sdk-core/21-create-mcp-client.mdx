...
<Snippet text={`import { experimental_createMCPClient } from "ai"`} prompt={false} />
              ...
              parameters: [
                {
                  name: 'type',
                  type: "'stdio'",
                  description: 'Use standard input/output streams for communication'
                },
                {
                  name: 'command',
                  type: 'string',
                ...
                },
                {
                  ...
                  isOptional: true,
                  description: 'Handler for stderr output. Defaults to "inherit".'
                }
              ]
            },
            {
