      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'CONTEXT',
              description:
                'The final state of the user-defined context object when the stream is aborted.',
            },
          ],
        },
      ],
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'PromiseLike<Array<InvalidToolCall>>',
      description: 'The invalid tool calls from the last step (tool not found or bad input). Automatically consumes the stream.',
    },
    {
