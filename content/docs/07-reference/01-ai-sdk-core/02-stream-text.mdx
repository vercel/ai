      ...
      properties: [
        {
          ...
          parameters: [
            ...
            {
              name: 'sendFinishReason',
              type: 'boolean',
              isOptional: true,
              description:
                'Send the finish reason in the finish event. Defaults to false for compatibility with older clients whose strict stream schema does not accept the finishReason field. Set to true when the client supports finish reasons.',
            },
            {
              name: 'sendStart',
              type: 'boolean',
