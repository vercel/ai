      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              isOptional: true,
              description: 'Callback function called when the stream finishes. Provides the updated messages, continuation and abort state, model finish reason, and operation-level outcome.',
            },
            {
