      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                'The parsed output based on the output specification. Undefined if parsing failed or no output specification was provided.',
            },
            {
              name: 'outputError',
              type: 'unknown | undefined',
              description:
                'Error that occurred during output parsing. Contains the error if parsing failed, undefined otherwise.',
            },
          ],
        },
      ],
