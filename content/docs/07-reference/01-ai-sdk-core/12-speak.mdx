---
title: speak
description: API Reference for speak.
---

# `speak()`

<Note type="warning">`speak` is an experimental feature.</Note>
...
const { audioData, contentType } = await speak({
...
<Snippet
  text={`import { experimental_speak as speak } from "ai"`}
  prompt={false}
/>
