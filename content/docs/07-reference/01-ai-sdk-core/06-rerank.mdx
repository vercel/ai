...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'User-defined runtime context available to lifecycle callbacks and telemetry integrations. It is not sent to the reranking model.',
    },
    {
      name: 'telemetry',
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Called when the rerank operation begins, before the reranking model is called. The event includes the full runtimeContext.',
    },
    {
      name: 'onEnd',
      ...
      isOptional: true,
      description:
        'Called when the rerank operation completes, after the reranking model returns. The event includes the full runtimeContext.',
    },
  ]}
/>
