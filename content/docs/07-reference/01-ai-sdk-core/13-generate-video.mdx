...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Additional HTTP headers for the request. Also forwarded when downloading URL-type videos.',
    },
    {
      name: 'download',
      type: '(options: { url: URL; abortSignal?: AbortSignal; headers?: Record<string, string> }) => Promise<{ data: Uint8Array; mediaType: string | undefined }>',
      isOptional: true,
      description:
