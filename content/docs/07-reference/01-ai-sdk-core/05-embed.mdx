...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'User-defined runtime context available to lifecycle callbacks and telemetry integrations. It is not sent to the embedding model.',
    },
    {
      name: 'telemetry',
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'Partial<Record<keyof RUNTIME_CONTEXT, boolean>>',
              isOptional: true,
              description:
                'Top-level runtime context properties to include in telemetry. Properties are excluded unless explicitly set to `true`.',
            },
            {
              name: 'integrations',
              isOptional: true,
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: 'RUNTIME_CONTEXT',
              description:
                'The full user-defined runtime context for the operation.',
            },
          ],
        },
      ],
