---
title: changeVoice
description: API Reference for changeVoice.
---

# `changeVoice()`

<Note type="warning">`changeVoice` is an experimental feature.</Note>

Changes the voice of an audio file.
...
<Snippet
  text={`import { experimental_changeVoice as changeVoice } from "ai"`}
  prompt={false}
/>
...
<PropertiesTable
  content={[
    {
      name: 'model',
      type: 'VoiceChangerModelV1',
      description: 'The voice changer model to use.',
    },
    {
      name: 'audio',
      type: 'DataContent (string | Uint8Array | ArrayBuffer | Buffer) | URL',
      description: 'The audio file to change the voice of.',
    },
    {
      name: 'voice',
      type: 'string',
...
<PropertiesTable
  content={[
    ...
    {
      name: 'warnings',
      type: 'VoiceChangerWarning[]',
      description:
        'Warnings from the model provider (e.g. unsupported settings).',
    },
    {
      name: 'responses',
      type: 'Array<VoiceChangerModelResponseMetadata>',
      description:
        'Response metadata from the provider. There may be multiple responses if we made multiple calls to the model.',
      properties: [
        {
          type: 'VoiceChangerModelResponseMetadata',
          parameters: [
            {
              name: 'timestamp',
              type: 'Date',
