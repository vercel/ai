...
`safeValidateUIMessages` performs the same validation as [`validateUIMessages`](/docs/reference/ai-sdk-core/validate-ui-messages#validation-behavior), including structural validation of all seven tool lifecycle states, `title` field preservation, tool input schema validation, and dynamic tool handling. See the [`validateUIMessages` validation behavior](/docs/reference/ai-sdk-core/validate-ui-messages#validation-behavior) documentation for details.
