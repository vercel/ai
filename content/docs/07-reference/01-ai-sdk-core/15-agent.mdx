...
```ts
import { ModelMessage, Sandbox } from '@ai-sdk/provider-utils';
...
export type AgentCallParameters<CALL_OPTIONS, TOOLS extends ToolSet = {}> = ([
  ...
  (
    ...
    /**
     * Sandbox environment that is passed through to tool execution.
     */
    sandbox?: Sandbox;
    /**
...
- `sandbox` (optional): A sandbox environment forwarded to tool execution.
