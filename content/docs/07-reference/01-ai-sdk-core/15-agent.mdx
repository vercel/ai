...
The `Agent` interface defines a contract for objects that can generate or stream AI-generated responses in reaction to prompts. Agents may encapsulate advanced logic such as tool usage, multi-step workflows, or prompt handling, enabling both simple and autonomous AI behaviors.
