...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'string',
      description:
        'The text to generate the speech from. When using Google Gemini 3.8 structured turns, pass an empty string and provide the transcript in providerOptions.google.turns.',
    },
    {
      name: 'voice',
      type: 'string',
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'The output format to use for the speech, such as "mp3" or "wav". Supported formats and defaults vary by provider and model. Google Gemini 3.8 also supports headerless "audio/l16", "audio/mulaw", and "audio/alaw" output.',
    },
    {
      name: 'instructions',
      type: 'string',
      isOptional: true,
      description:
        'Instructions for the speech generation. Google Gemini 3.8 sends these as delivery style metadata without changing the transcript. Explicit per-turn styles override these instructions.',
    },
    {
      name: 'speed',
      type: 'number',
