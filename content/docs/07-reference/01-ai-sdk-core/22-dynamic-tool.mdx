      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              name: 'needsApproval',
              isOptional: true,
              type: 'boolean | ((input: unknown, options: { toolCallId: string; messages: ModelMessage[]; experimental_context: Context }) => boolean | Promise<boolean>)',
              description:
                'Whether the tool needs user approval before execution. Can be a boolean or a function that receives the tool input plus execution metadata.'
            },
            {
              name: 'inputSchema',
                ...
                properties: [
                  {
                    ...
                    },
                    {
                      ...
                      },
                      {
                        ...
                        type: "Context",
                        description: "User-defined context that is passed into tool execution. Experimental (can break in patch releases)."
                      }
                    ]
                  }
                ]
