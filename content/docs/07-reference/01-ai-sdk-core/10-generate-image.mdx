...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Custom download function to control how URLs are fetched when they appear in image results. By default, files are downloaded automatically. Experimental feature. Return null to pass the URL directly (when supported), or return downloaded content with data and media type.',
    },
  ]}
/>
