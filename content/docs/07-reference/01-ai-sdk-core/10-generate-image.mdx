...
<PropertiesTable
  content={[
    ...
    {
      name: 'calls',
      type: 'Array<GenerateImageCall>',
      description:
        'The completed underlying image model calls. Each call preserves its images, provider metadata, response metadata, warnings, and usage.',
      properties: [
        {
          ...
          parameters: [
            {
              name: 'images',
              type: 'Array<GeneratedFile>',
              description: 'The images generated by this call.',
            },
            {
              name: 'providerMetadata',
              type: 'ImageModelProviderMetadata',
              isOptional: true,
              description: 'Provider-specific metadata for this call.',
            },
            {
              name: 'response',
              type: 'ImageModelResponseMetadata',
              description: 'Response metadata for this call.',
            },
            {
              name: 'warnings',
              type: 'Array<Warning>',
              description: 'Warnings from this call.',
            },
            {
              name: 'usage',
              type: 'ImageModelUsage',
              isOptional: true,
              description: 'Usage reported for this call.',
            },
          ],
        },
      ],
