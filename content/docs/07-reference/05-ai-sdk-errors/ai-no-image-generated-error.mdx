...
- `calls`: Results from the completed underlying image model calls, including generated images, provider metadata, response metadata, warnings, and usage for each call (optional).
