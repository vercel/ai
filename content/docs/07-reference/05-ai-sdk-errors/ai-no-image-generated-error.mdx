...
- `warnings`: Warnings from completed image model calls (optional).
- `providerMetadata`: Provider-specific metadata from completed image model calls (optional).
- `usage`: Combined token usage across completed image model calls (optional).
