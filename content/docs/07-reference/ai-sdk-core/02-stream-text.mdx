...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description:
        'A stream with all events, including text deltas, tool calls, tool results, and errors. You can use it as either an AsyncIterable or a ReadableStream. Only errors that break the stream are thrown.',
      properties: [
        {
          type: 'TextStreamPart',
          parameters: [
