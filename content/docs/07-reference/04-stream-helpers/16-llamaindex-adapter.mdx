...
The `@ai-sdk/llamaindex` module provides helper functions to transform LlamaIndex output streams into data streams and data stream responses.
...
<Snippet text={`import { toDataResponse } from "@ai-sdk/llamaindex"`} prompt={false} />
