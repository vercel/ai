...
<PropertiesTable
  content={[
    {
      name: 'model',
      type: 'string | CompatibleLanguageModel',
      isRequired: true,
      description:
        'The model to use. A string compatible with the Vercel AI Gateway (e.g., \'anthropic/claude-sonnet-4-6\') or a LanguageModelV4 instance.',
    },
    {
      name: 'instructions',
  ...
  content={[
    {
      ...
      type: 'Array<ModelMessage>',
      isRequired: true,
      description: 'The conversation messages to process.',
    },
    {
      name: 'writable',
