...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Default stop condition for the agent loop. Default: isStepCount(20). In @ai-sdk/workflow 2.0.19 and earlier, omitting this option allowed unlimited natural completion. Per-stream values override this default. Use `isLoopFinished()` to preserve the previous unlimited behavior, but beware of potential runaway loops. See https://ai-sdk.dev/v7/docs/reference/ai-sdk-core/loop-finished#isloopfinished.',
    },
    {
      name: 'activeTools',
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'StopCondition | StopCondition[]',
      isOptional: true,
      description: 'Condition(s) for ending the agent loop. Default: isStepCount(20). In @ai-sdk/workflow 2.0.19 and earlier, omitting this option allowed unlimited natural completion. Use `isLoopFinished()` to preserve the previous unlimited behavior, but beware of potential runaway loops. See https://ai-sdk.dev/v7/docs/reference/ai-sdk-core/loop-finished#isloopfinished.',
    },
