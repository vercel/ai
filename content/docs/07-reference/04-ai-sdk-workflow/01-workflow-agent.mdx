      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description: 'Tool-specific context object for the tool call that is about to execute.',
            },
          ],
        },
      ],
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              name: 'toolContext',
              type: 'InferToolSetContext<TOOLS>',
              description: 'Tool-specific context object for the tool call that just completed.',
            },
            {
              name: 'toolOutput',
