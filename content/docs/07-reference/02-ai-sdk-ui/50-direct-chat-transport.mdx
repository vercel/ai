...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Send the finish reason in the finish event. Set to false when supporting older clients whose strict stream schema does not accept the finishReason field. Defaults to true.',
    },
    {
      name: 'sendStart',
      type: 'boolean',
