      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                "Declares the operation-level outcome of the composed stream. The first terminal outcome is retained. Supported statuses are 'completed', 'failed', 'aborted', and 'unknown'. Declaring an outcome does not write a chunk or close the stream.",
            },
            {
              name: 'onError',
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              description:
                'The operation-level outcome declared by the stream owner. It is separate from model finish reasons and individual error chunks.',
            },
            {
