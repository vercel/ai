---
title: useRealtime
description: API reference for the useRealtime hook.
---

# `useRealtime()`

<Note type="warning">`useRealtime` is an experimental feature.</Note>
...
<Snippet text={`import { useRealtime } from "@ai-sdk/react"`} prompt={false} />
...
<PropertiesTable
  content={[
          ...
          parameters: [
            {
              ...
              type: 'string',
              description:
                'The setup endpoint that returns a RealtimeSetupResponse.',
            },
          ],
        },
      ],
    ...
    {
      name: 'sessionConfig',
      type: 'Partial<RealtimeSessionConfig>',
      isOptional: true,
      description:
        'Provider-neutral session configuration, such as instructions, voice, audio formats, turn detection, tools, and providerOptions.',
    },
    {
      name: 'sampleRate',
      type: 'number',
    ...
    {
      name: 'onEvent',
      type: '(event: RealtimeServerEvent) => void',
      isOptional: true,
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Recent normalized provider events for inspection or debug UI.',
    },
    {
      name: 'isCapturing',
      type: 'boolean',
    ...
    {
      name: 'sendEvent',
      type: '(event: RealtimeClientEvent) => void',
