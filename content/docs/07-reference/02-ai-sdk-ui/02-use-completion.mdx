...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: '<T extends Function>(f: T) => T',
      isOptional: true,
      description:
        'React only. A custom function that throttles the completion state updates. It should take a function as input and return a throttled version of that function.',
    },
  ]}
/>
