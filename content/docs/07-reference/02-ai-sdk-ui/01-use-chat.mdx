...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Optional callback function that is invoked when a tool call is received. Return a value to provide the tool result, or return undefined to handle the tool call manually.',
    },
    {
      name: 'onFinish',
