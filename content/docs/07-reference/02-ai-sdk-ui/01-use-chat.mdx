  ...
  content={[
    {
      ...
      isOptional: true,
      description:
        'An existing Chat instance to use. If provided, other ChatInit parameters are ignored.',
    },
    {
      name: 'transport',
      type: 'ChatTransport',
    ...
    },
    {
      ...
      type: 'number',
      isOptional: true,
      description: 'Maximum number of tool execution steps. Defaults to 1.',
    },
    {
      name: 'onToolCall',
      ...
      isOptional: true,
      description:
        'Optional callback function that is invoked when a tool call is received. Intended for automatic client-side tool execution.',
    },
    {
      name: 'onFinish',
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Function to send a new message to the chat.',
    },
    {
      name: 'regenerate',
      type: '(options?: { messageId?: string }) => void',
      description:
        'Function to regenerate the last assistant message or a specific message.',
    },
    {
      name: 'stop',
      type: '() => void',
      description: 'Function to stop the current streaming response.',
    },
    {
      name: 'resumeStream',
      type: '() => void',
      description: 'Function to resume an interrupted stream.',
    },
    {
      name: 'addToolResult',
      type: '(options: { toolCallId: string; result: unknown }) => void',
      description: 'Function to add a tool result to the chat.',
    },
    {
      name: 'setMessages',
      type: '(messages: UIMessage[] | ((messages: UIMessage[]) => UIMessage[])) => void',
      description: 'Function to update the messages state locally.',
    },
  ]}
/>
