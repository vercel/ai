...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'Publication cadence in milliseconds for React message snapshots. Defaults to 50ms. The leading snapshot is immediate, and final messages are flushed with ready or error. Set to 0 to publish every snapshot without throttling. Stream processing and callbacks are not delayed.',
    },
    {
      name: 'resume',
      type: 'boolean',
