...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        'React only. A custom function that throttles the message and data updates. It should take a function as input and return a throttled version of that function.',
    },
  ]}
/>
