...
The AI SDK also includes a [harness abstraction](/docs/harnesses) for using
...
- **[AI SDK Harnesses](/docs/harnesses):** A uniform API for running established agent harnesses with `HarnessAgent`.
