...
Now, you must register the `OpenTelemetryIntegration` at the top of any file where you use the AI SDK. For Next.js, place this at the top of your route files (not in `instrumentation.ts`):

```tsx filename="AI SDK 7 — app/api/chat/route.ts"
