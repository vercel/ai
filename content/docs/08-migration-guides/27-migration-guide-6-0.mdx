...
The deprecated `CoreMessage` type, schemas, and functions have been removed ([PR #10710](https://github.com/vercel/ai/pull/10710)).
...
The `strictJsonSchema` setting for JSON outputs and tool calls is enabled by default ([PR #10752](https://github.com/vercel/ai/pull/10752)).
...
The tool strict mode is now controlled by setting `strict` on each tool ([PR #10817](https://github.com/vercel/ai/pull/10817)).
...
The `structuredOutputs` provider option has been removed from chat models ([PR #10752](https://github.com/vercel/ai/pull/10752)). You can use `strictJsonSchema` instead.
