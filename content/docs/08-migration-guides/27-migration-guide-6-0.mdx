...
<Note type="warning">
  ...
  tool approval. Unlike AI SDK 5, this release is not expected to have major
  breaking changes for most users. This guide will help you migrate from AI SDK
  5.0 to 6.0 Beta. Note that you may want to wait until the stable release for
  production projects. See the [AI SDK 6 Beta
  announcement](/docs/announcing-ai-sdk-6-beta) for more details on what's new.
</Note>
