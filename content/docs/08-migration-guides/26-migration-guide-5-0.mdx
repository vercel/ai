...
If you call `openai.chat(...)` to use the Chat Completions API directly, you can type it with `OpenAILanguageModelChatOptions`. AI SDK 5 adds the same `strictJsonSchema` option there as well.
