...
<Note>
  When using Gemini 3 Flash, the correct model id includes the preview suffix:
  use <InlineCode>gemini-3-flash-preview</InlineCode>.
  Here's a route example with AI SDK UI:
</Note>
