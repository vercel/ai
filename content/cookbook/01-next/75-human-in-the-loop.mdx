...
To see this code in action, check out the [`next-openai` example](https://github.com/vercel/ai/tree/main/examples/next-openai-pages) in the AI SDK repository. Navigate to the `/test-tool-approval` page and associated route handler.
