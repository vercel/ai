---
title: Express
description: Example of using Vercel AI SDK in an Express server.
---

# Express

You can use the Vercel AI SDK in an [Express](https://expressjs.com/) server to generate and stream text and objects to the client.
...
```ts file='index.ts' highlight="8-10,15-18,21"
import { openai } from '@ai-sdk/openai';
