---
title: Fastify
description: Example of using Vercel AI SDK in a Fastify server.
---

# Fastify

You can use the Vercel AI SDK in a [Fastify](https://fastify.dev/) server to generate and stream text and objects to the client.
...
```ts file='index.ts' highlight="8-10,15-18,25"
import { openai } from '@ai-sdk/openai';
