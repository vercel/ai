---
title: Loading State
description: Learn to manage loading state using the Vercel AI SDK in your Next.js App Router application
---

# Handling Loading State

<Note>This example uses React Server Components (RSC).</Note>

Given that responses from language models can often take a while to complete, it's crucial to be able to show loading state to users. This provides visual feedback that the system is working on their request and helps maintain a positive user experience. Managing loading state is very similar to how you would approach loading state in a traditional Next.js application.
...
```typescript filename='app/actions.ts' highlight='11,24,27'
'use server';
