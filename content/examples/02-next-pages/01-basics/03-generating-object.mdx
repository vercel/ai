...
description: Learn to generate structured data using the Vercel AI SDK in your Next.js Pages Router application
---
...
<Note>
  ...
  Components (RSC) instead, check out the ["generate object" example with
  RSCs](/examples/next-app/basics/generating-object).
</Note>
