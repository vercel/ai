...
description: Learn to generate text using the Vercel AI SDK in your Next.js Pages Router application
---
...
<Note>
  ...
  Components (RSC) instead, check out the ["generate text" example with
  RSCs](/examples/next-app/basics/generating-text).
</Note>
