...
description: Learn to render a React component during a tool call using the Vercel AI SDK in your Next.js Pages Router application
---
...
Let's build an assistant that gets the weather for any city by calling the `getWeatherInformation` tool. Instead of returning text during the tool call, we will render a React component that displays the weather information on the client.
