...
description: Explore examples of how to use the AI SDK in Next.js Pages Router.
---

# Examples for Next.js Pages Router

The AI SDK is designed to work with Next.js Pages Router. The examples will demonstrate querying the language model and rendering the user interfaces using `ai/core` and `ai/react`, respectively.
