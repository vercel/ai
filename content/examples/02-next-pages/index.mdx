...
The Vercel AI SDK is designed to work with Next.js Pages Router. The examples will demonstrate querying the language model and rendering the user interfaces using `ai/core` and `@ai-sdk/react`, respectively.
