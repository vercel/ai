...
| SpaceXAI  | [`packages/spacexai/src/files/spacexai-files.ts`](../packages/spacexai/src/files/spacexai-files.ts) | [`packages/spacexai/src/convert-to-spacexai-chat-messages.ts`](../packages/spacexai/src/convert-to-spacexai-chat-messages.ts)         |
