...
| Anthropic | [`packages/anthropic/src/anthropic-files.ts`](../packages/anthropic/src/anthropic-files.ts) | [`packages/anthropic/src/convert-to-anthropic-prompt.ts`](../packages/anthropic/src/convert-to-anthropic-prompt.ts) |
...
| xAI       | [`packages/xai/src/files/xai-files.ts`](../packages/xai/src/files/xai-files.ts)             | [`packages/xai/src/responses/convert-to-xai-responses-input.ts`](../packages/xai/src/responses/convert-to-xai-responses-input.ts)     |
