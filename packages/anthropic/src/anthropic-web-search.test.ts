...
describe('Anthropic Web Search Server-Side Tool', () => {
  ...
  describe('Provider Options Approach', () => {
  ...
  describe('Tools Approach', () => {
    ...
    it('should pass web search configuration with blocked domains using tools approach', async () => {
      prepareJsonResponse({
        type: 'message',
        id: 'msg_test',
    ...
    it('should handle web search with user location using tools approach', async () => {
      prepareJsonResponse({
        type: 'message',
        id: 'msg_test',
    ...
    it('should work alongside regular client-side tools when using tools approach', async () => {
      prepareJsonResponse({
        type: 'message',
        id: 'msg_test',
