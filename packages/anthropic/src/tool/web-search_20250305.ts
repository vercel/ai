...
export const webSearch_20250305ArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
export const webSearch_20250305OutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.array(
      z.object({
        url: z.string(),
...
const webSearch_20250305InputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      query: z.string(),
    }),
