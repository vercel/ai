...
export const webFetch_20260209ArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
export const webFetch_20260209OutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
const webFetch_20260209InputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      url: z.string(),
    }),
