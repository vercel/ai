...
export const webSearch_20260209ArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
export const webSearch_20260209OutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.array(
      z.object({
        url: z.string(),
...
const webSearch_20260209InputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      query: z.string(),
    }),
