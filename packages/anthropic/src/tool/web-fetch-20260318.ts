...
export const webFetch_20260318ArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
export const webFetch_20260318OutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
const webFetch_20260318InputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      url: z.string(),
    }),
...
const factory = /* @__PURE__ */ createProviderExecutedToolFactory<
  ...
  },
  {
    ...
    /**
     * Whether cached content may be returned. Set to `false` to fetch fresh
     * content. Defaults to `true`.
     */
    useCache?: boolean;

    /**
     * Controls whether web fetch result blocks consumed by completed code
...
>({
  ...
  inputSchema: webFetch_20260318InputSchema,
  outputSchema: webFetch_20260318OutputSchema,
  supportsDeferredResults: true,
});

export const webFetch_20260318 = (
