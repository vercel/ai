      ...
      it('should stream sources and tool calls', async () => {
        ...
        expect(await convertReadableStreamToArray(stream))
          ...
          [
            ...
            {
              "text": "I'll search for the latest stock market trends and financial news",
              "type": "text",
            },
            {
              "inputTextDelta": "",
            ...
            {
              "inputTextDelta": "query": "latest stock ",
              "toolCallId": "srvtoolu_01WLwJ9AzAmNar5vFyc4ye6X",
              "toolCallType": "function",
              "toolName": "web_search",
              "type": "tool-call-delta",
            ...
            {
              "inputTextDelta": "ket trends financial",
              "toolCallId": "srvtoolu_01WLwJ9AzAmNar5vFyc4ye6X",
              "toolCallType": "function",
              "toolName": "web_search",
              "type": "tool-call-delta",
            ...
            {
              "inputTextDelta": " news June 20 2025"}",
              "toolCallId": "srvtoolu_01WLwJ9AzAmNar5vFyc4ye6X",
              "toolCallType": "function",
              "toolName": "web_search",
              "type": "tool-call-delta",
          ...
          Error message: Unterminated string in JSON at position 99 (line 1 column 100)],
              "type": "error",
            },
            {
