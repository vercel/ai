...
> {
  /**
   * Optional header to specify the beta versions to enable for the request.
   * @see https://platform.claude.com/docs/en/api/beta-headers
   * https://platform.claude.com/docs/en/api/http/beta#anthropic_beta
   */
  'anthropic-beta'?: AnthropicBeta | AnthropicBeta[];
  /**
   * Optional user profile ID to associate with the request. Use when acting on behalf of a
   * party other than your organization. Requires the `user-profiles` beta header.
   */
  'anthropic-user-profile-id'?: string;
  /**
   * Optional workspace ID to associate with the request.
   */
