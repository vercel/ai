...
- cbd0fe3: feat (provider/perplexity): add embedding model support
...
- 05ce262: Fix Perplexity prompt conversion for file parts with unsupported media types and top-level PDF media types.
...
- 6ffec02: fix perplexityChunkSchema to allow optional role and nullish content in streaming chunks
...
- 4bcec3c: feat(perplexity): expose provider-reported cost in providerMetadata
