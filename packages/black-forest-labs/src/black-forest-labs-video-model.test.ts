...
>>>>>>> ef78f46c20 (fix(black-forest-labs): report the settled cost for FLUX 3 video (#18439))
    ...
    it('should reject an untrusted polling URL', async () => {
      server.urls[SUBMIT_URL].response = {
        type: 'json-value',
        body: {
          ...submitResponse,
          polling_url: 'https://evil.example/poll',
        },
      };
      ...
      await expect(
        ...
        'Black Forest Labs returned an untrusted polling URL: https://evil.example/poll?id=req-123',
      );
