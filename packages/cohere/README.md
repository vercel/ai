...
> **Deploying to Vercel?** The AI Gateway lets you reach Cohere (and other providers) by changing a single string — no provider packages or API keys needed. [Get started with AI Gateway](https://vercel.com/ai-gateway).
