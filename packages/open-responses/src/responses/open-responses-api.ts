...
export type CustomToolCallItemParam = {
  id?: string;
  call_id: string;
...
export type CustomToolCallOutputItemParam = {
  id?: string;
  call_id: string;
...
export type SpecificCustomToolParam = {
  type: 'custom';
  name: string;
};
...
export type OpenResponsesRequestBody = {
   ...
   */
  tools?: Array<
    FunctionToolParam | CustomToolParam | OpenResponsesExtensionRecord
  >;
