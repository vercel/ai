...
The **Nebul provider** for the [AI SDK](https://ai-sdk.dev/docs) contains language, embedding, image, transcription, and speech model support for the [Nebul Inference API](https://docs.nebul.io/docs/inference-api).
