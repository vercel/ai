...
export const spacexaiTranscriptionModelOptionsSchema = lazySchema(() =>
  zodSchema(
    z.object({
      /**
...
export type SpaceXAITranscriptionModelOptions = InferSchema<
  typeof spacexaiTranscriptionModelOptionsSchema
>;
