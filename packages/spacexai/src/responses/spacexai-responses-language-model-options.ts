...
export type SpaceXAIResponsesModelId =
 ...
 */
export const spacexaiLanguageModelResponsesOptions = z.object({
  /**
...
export type SpaceXAILanguageModelResponsesOptions = z.infer<
  typeof spacexaiLanguageModelResponsesOptions
>;
