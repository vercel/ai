...
export type SpaceXAIResponsesIncludeValue =
  | 'file_search_call.results'
  | 'reasoning.encrypted_content';

export type SpaceXAIResponsesIncludeOptions =
  | Array<SpaceXAIResponsesIncludeValue>
  | undefined
  | null;

export type SpaceXAIResponsesInput = Array<SpaceXAIResponsesInputItem>;

export type SpaceXAIResponsesInputItem =
  | SpaceXAIResponsesSystemMessage
  | SpaceXAIResponsesUserMessage
  | SpaceXAIResponsesAssistantMessage
  | SpaceXAIResponsesFunctionCallOutput
  | SpaceXAIResponsesReasoning
  | SpaceXAIResponsesToolCall;

export type SpaceXAIResponsesSystemMessage = {
  role: 'system' | 'developer';
  content: string;
};

export type SpaceXAIResponsesUserMessageContentPart =
...
export type SpaceXAIResponsesUserMessage = {
  role: 'user';
  content: Array<SpaceXAIResponsesUserMessageContentPart>;
};

export type SpaceXAIResponsesAssistantMessage = {
  role: 'assistant';
  content: string;
  id?: string;
};

export type SpaceXAIResponsesFunctionCallOutput = {
...
export type SpaceXAIResponsesReasoning = {
  type: 'reasoning';
  id: string;
  summary: Array<{
    type: 'summary_text';
...
export type SpaceXAIResponsesToolCall = {
  type:
    | 'function_call'
    | 'web_search_call'
    | 'x_search_call'
...
export type SpaceXAIResponsesTool =
  | {
      type: 'web_search';
...
export const spacexaiResponsesUsageSchema = z.object({
...
export const spacexaiResponsesResponseSchema = z.object({
  id: z.string().nullish(),
  created_at: z.number().nullish(),
  model: z.string().nullish(),
  object: z.literal('response'),
  output: z.array(outputItemSchema),
  usage: spacexaiResponsesUsageSchema.nullish(),
  status: z.string(),
  service_tier: z.string().nullish(),
});

export const spacexaiResponsesChunkSchema = z.union([
  z.object({
    type: z.literal('response.created'),
    response: spacexaiResponsesResponseSchema.partial({
      usage: true,
      status: true,
    }),
  }),
  ...
  z.object({
    ...
    response: spacexaiResponsesResponseSchema,
  }),
  z.object({
...
export type SpaceXAIResponsesResponse = z.infer<
  typeof spacexaiResponsesResponseSchema
>;
export type SpaceXAIResponsesChunk = z.infer<
  typeof spacexaiResponsesChunkSchema
>;
export type SpaceXAIResponsesUsage = z.infer<
  typeof spacexaiResponsesUsageSchema
>;
