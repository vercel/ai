...
export type SpaceXAIChatModelId =
...
// SpaceXAI-specific provider options
export const spacexaiLanguageModelChatOptions = z.object({
  /**
   ...
   * instead (e.g. `spacexai.tools.webSearch()`, `spacexai.tools.xSearch()`)
   * with `spacexai.responses(modelId)`.
   *
...
export type SpaceXAILanguageModelChatOptions = z.infer<
  typeof spacexaiLanguageModelChatOptions
>;
