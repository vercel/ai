...
type LegacyTelemetryOptions = TelemetryOptions & {
 ...
 */
function getTracer(telemetry?: LegacyTelemetryOptions): Tracer | null {
...
function buildAttributes(
  operationId: string,
  telemetry: LegacyTelemetryOptions | undefined,
  extra?: Attributes,
): Attributes {
...
export async function recordSpan<T>(options: {
  name: string;
  telemetry?: LegacyTelemetryOptions;
