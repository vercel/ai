...
describe('google-vertex-provider', () => {
  ...
  describe('Imagen 4 Models', () => {
    it('should create imagen-4.0-generate-preview-06-06 model', () => {
      const provider = createVertex({
        project: 'test-project',
        location: 'us-central1',
      });
      provider.image('imagen-4.0-generate-preview-06-06');
    ...
    it('should create imagen-4.0-fast-generate-preview-06-06 model', () => {
      const provider = createVertex({
        project: 'test-project',
        location: 'us-central1',
      });
      provider.image('imagen-4.0-fast-generate-preview-06-06');
    ...
    it('should create imagen-4.0-ultra-generate-preview-06-06 model', () => {
      const provider = createVertex({
        project: 'test-project',
        location: 'us-central1',
      });
      provider.image('imagen-4.0-ultra-generate-preview-06-06');
    ...
    it('should create Imagen 4 models using imageModel method', () => {
      const provider = createVertex({
        project: 'test-project',
        location: 'us-central1',
      });
      provider.imageModel('imagen-4.0-generate-preview-06-06');
