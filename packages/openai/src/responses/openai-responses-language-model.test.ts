  ...
  describe('transformRequestBody', () => {
    ...
    function prepareTransformStreamResponse() {
      server.urls['https://api.openai.com/v1/responses'].response = {
        type: 'stream-chunks',
        chunks: [
          `data: {"type":"response.created","response":{"id":"resp_test","object":"response","created_at":1711115037,"model":"gpt-4o","output":[],"usage":null}}\n\n`,
          `data: {"type":"response.output_item.added","output_index":0,"item":{"type":"message","id":"msg_test","role":"assistant","content":[]}}\n\n`,
          `data: {"type":"response.output_text.delta","output_index":0,"content_index":0,"item_id":"msg_test","delta":"Hello!"}\n\n`,
          `data: {"type":"response.output_item.done","output_index":0,"item":{"type":"message","id":"msg_test","role":"assistant","content":[{"type":"output_text","text":"Hello!","annotations":[]}]}}\n\n`,
          `data: {"type":"response.completed","response":{"id":"resp_test","object":"response","created_at":1711115037,"model":"gpt-4o","output":[{"type":"message","id":"msg_test","role":"assistant","content":[{"type":"output_text","text":"Hello!","annotations":[]}]}],"usage":{"input_tokens":4,"output_tokens":2}}}\n\n`,
          'data: [DONE]\n\n',
        ],
      };
    }
    ...
    it('should work without transformRequestBody', async () => {
      ...
      const model = new OpenAIResponsesLanguageModel('gpt-4o', {
        ...
        headers: () => ({}),
        generateId: mockId(),
        // No transformRequestBody provided
      });
      ...
      // Should still work and send the original body
      const requestBody = await server.calls[0].requestBodyJson;
