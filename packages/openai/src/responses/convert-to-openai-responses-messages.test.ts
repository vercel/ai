...
describe('convertToOpenAIResponsesMessages', () => {
  ...
  describe('assistant messages', () => {
    ...
    describe('reasoning messages', () => {
          ...
          prompt: [
            ...
            },
            {
              ...
              content: [
                {
                  type: 'reasoning',
                  text: 'First reasoning part (first message)',
                  providerOptions: {
                    openai: {
                      reasoning: {
                        id: 'reasoning_123',
                ...
                {
                  type: 'reasoning',
                  text: 'Second reasoning part (first message)',
                  providerOptions: {
                    openai: {
                      reasoning: {
                        id: 'reasoning_123',
            ...
            },
            {
              ...
              content: [
                {
                  type: 'reasoning',
                  text: 'First reasoning part (second message)',
                  providerOptions: {
                    openai: {
                      reasoning: {
                        id: 'reasoning_123',
                ...
                {
                  type: 'reasoning',
                  text: 'Second reasoning part (second message)',
                  providerOptions: {
                    openai: {
                      reasoning: {
                        id: 'reasoning_123',
      ...
      it('should throw error when reasoning parts with same ID (within the same assistant message) have mismatched encrypted content', async () => {
        await expect(
          convertToOpenAIResponsesMessages({
            prompt: [
              {
