...
describe('prepareChatTools', () => {
  ...
  describe('allowedTools provider option', () => {
    it('should emit allowed_tools with default auto mode', () => {
      const result = prepareChatTools({
        tools: [
          {
            type: 'function',
    ...
    it('should emit allowed_tools with required mode', () => {
      const result = prepareChatTools({
        tools: [
          {
            type: 'function',
    ...
    it('should override request-level toolChoice when allowedTools is set', () => {
      const result = prepareChatTools({
        tools: [
          {
            type: 'function',
