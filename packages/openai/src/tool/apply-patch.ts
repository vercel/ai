 ...
 *
 */
export const applyPatchInputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      callId: z.string(),
 ...
 */
export const applyPatchOutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
 ...
 */
export const applyPatchArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(z.object({})),
);
