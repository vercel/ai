...
export const webSearchPreviewArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
export const webSearchPreviewInputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(z.object({})),
);

const webSearchPreviewOutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      action: z
