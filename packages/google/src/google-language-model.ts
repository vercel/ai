    ...
    for (const part of parts) {
      if ('executableCode' in part && part.executableCode?.code) {
        ...
        content.push({
          ...
          toolCallId: part.functionCall.id ?? this.generateId(),
        ...
        const toolCallId = part.toolCall.id ?? this.generateId();
        ...
        const responseToolCallId =
          lastServerToolCallId ?? part.toolResponse.id ?? this.generateId();
        content.push({
          type: 'tool-result',
