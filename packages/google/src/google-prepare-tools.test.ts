...
it('should preserve recursive function tool schemas and report unsupported JSON Schema constraints', () => {
  const inputSchema = {
    type: 'object',
    properties: {
  ...
  expect(result.toolWarnings).toEqual([
    {
      ...
      details:
        'The constraint at "/properties/label/pattern" is not supported by the Google function parameter JSON Schema surface. The schema is sent unchanged, but this constraint may not restrict values generated by the model.',
    },
    {
      type: 'compatibility',
