...
// import { screen, waitFor, renderHook } from '@solidjs/testing-library';
...
//     await waitFor(() => {
//       expect(screen.getByTestId('isFinished')).toHaveTextContent('true');
//     });
...
//       onFinish: options => {
//         console.log('onFinish', options?.message?.parts);
//         onFinishCalls.push(options);
//       },
//       generateId: mockId(),
...
//     expect(screen.getByTestId('message-0-dmoe')).toBeInTheDocument();
