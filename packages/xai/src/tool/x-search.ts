...
export const xSearchArgsSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
...
const xSearchOutputSchema = /* @__PURE__ */ lazySchema(() =>
  zodSchema(
    z.object({
      query: z.string(),
      posts: z.array(
...
const xSearchToolFactory = /* @__PURE__ */ createProviderExecutedToolFactory<
  {},
  {
    query: string;
    posts: Array<{
