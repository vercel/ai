...
- a2d81eb: fix(xai): preserve web_search action (query, sources, open_page) in responses tool results
...
- 54beea0: Warn when xAI Responses models ignore unsupported sampling settings.
