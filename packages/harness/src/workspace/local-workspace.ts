 ...
 * per-session run state) lives in `~/.ai-sdk-harness`, never inside the
 * project. Conversations belong to the runtime's own store, so they can be
 * continued directly in the agent's own CLI too.
 *
