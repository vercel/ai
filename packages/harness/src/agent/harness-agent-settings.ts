...
> = {
   ...
   * lives under the fixed `~/.ai-sdk-harness` root, never inside the
   * project, and conversations belong to the runtime's own store so they can
   * be continued directly in the agent's own CLI.
   *
