                ...
                for (const toolPart of toolParts) {
                  ...
                  switch (toolPart.state) {
                    ...
                    case 'approval-responded': {
                      ...
                      // For approved tools (approved=true), no tool-result is
                      // emitted here. streamText's collectToolApprovals
                      // intercepts the approval-response and executes the
                      // tool, appending the result to responseMessages.
                      break;
                    }
