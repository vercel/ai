...
import { detectMimeType } from './detect-mimetype';
...
describe('detectMimeType', () => {
  describe('GIF', () => {
    ...
    it('should detect GIF from base64', () => {
      ...
      expect(detectMimeType(gifBase64)).toBe('image/gif');
    });
  });
  ...
  describe('PNG', () => {
    ...
    it('should detect PNG from base64', () => {
      ...
      expect(detectMimeType(pngBase64)).toBe('image/png');
    });
  });
  ...
  describe('JPEG', () => {
    ...
    it('should detect JPEG from base64', () => {
      ...
      expect(detectMimeType(jpegBase64)).toBe('image/jpeg');
    });
  });
  ...
  describe('WebP', () => {
    ...
    it('should detect WebP from base64', () => {
      ...
      expect(detectMimeType(webpBase64)).toBe('image/webp');
    });
  });
  ...
  describe('TIFF', () => {
    it('should detect TIFF (little endian) from bytes', () => {
      ...
      expect(detectMimeType(tiffLEBytes)).toBe('image/tiff');
    });
    ...
    it('should detect TIFF (big endian) from base64', () => {
      ...
      expect(detectMimeType(tiffBEBase64)).toBe('image/tiff');
    });
  });
  ...
  describe('error cases', () => {
    it('should return undefined for unknown image formats', () => {
      ...
      expect(detectMimeType(unknownBytes)).toBeUndefined();
    });

    it('should return undefined for empty arrays', () => {
      const emptyBytes = new Uint8Array([]);
      expect(detectMimeType(emptyBytes)).toBeUndefined();
    });
    ...
    it('should return undefined for arrays shorter than signature length', () => {
      ...
      expect(detectMimeType(shortBytes)).toBeUndefined();
    });

    it('should return undefined for invalid base64 strings', () => {
      const invalidBase64 = 'invalid123';
      expect(detectMimeType(invalidBase64)).toBeUndefined();
    });
  });
});
