...
describe('detectMimeType', () => {
  describe('GIF', () => {
    it('should detect GIF from bytes', () => {
      ...
      expect(detectMimeType(gifBytes, imageMimeTypeSignatures)).toBe(
        'image/gif',
      );
    });
    ...
    it('should detect GIF from base64', () => {
      ...
      expect(detectMimeType(gifBase64, imageMimeTypeSignatures)).toBe(
        'image/gif',
      );
    });
  });
  ...
  describe('PNG', () => {
    it('should detect PNG from bytes', () => {
      ...
      expect(detectMimeType(pngBytes, imageMimeTypeSignatures)).toBe(
        'image/png',
      );
    });
    ...
    it('should detect PNG from base64', () => {
      ...
      expect(detectMimeType(pngBase64, imageMimeTypeSignatures)).toBe(
        'image/png',
      );
    });
  });
  ...
  describe('JPEG', () => {
    it('should detect JPEG from bytes', () => {
      ...
      expect(detectMimeType(jpegBytes, imageMimeTypeSignatures)).toBe(
        'image/jpeg',
      );
    });
    ...
    it('should detect JPEG from base64', () => {
      ...
      expect(detectMimeType(jpegBase64, imageMimeTypeSignatures)).toBe(
        'image/jpeg',
      );
    });
  });
  ...
  describe('WebP', () => {
    it('should detect WebP from bytes', () => {
      ...
      expect(detectMimeType(webpBytes, imageMimeTypeSignatures)).toBe(
        'image/webp',
      );
    });
    ...
    it('should detect WebP from base64', () => {
      ...
      expect(detectMimeType(webpBase64, imageMimeTypeSignatures)).toBe(
        'image/webp',
      );
    });
  });
  ...
  describe('BMP', () => {
    it('should detect BMP from bytes', () => {
      ...
      expect(detectMimeType(bmpBytes, imageMimeTypeSignatures)).toBe(
        'image/bmp',
      );
    });
    ...
    it('should detect BMP from base64', () => {
      ...
      expect(detectMimeType(bmpBase64, imageMimeTypeSignatures)).toBe(
        'image/bmp',
      );
    });
  });
  ...
  describe('TIFF', () => {
    it('should detect TIFF (little endian) from bytes', () => {
      ...
      expect(detectMimeType(tiffLEBytes, imageMimeTypeSignatures)).toBe(
        'image/tiff',
      );
    });
    ...
    it('should detect TIFF (little endian) from base64', () => {
      ...
      expect(detectMimeType(tiffLEBase64, imageMimeTypeSignatures)).toBe(
        'image/tiff',
      );
    });
    ...
    it('should detect TIFF (big endian) from bytes', () => {
      ...
      expect(detectMimeType(tiffBEBytes, imageMimeTypeSignatures)).toBe(
        'image/tiff',
      );
    });
    ...
    it('should detect TIFF (big endian) from base64', () => {
      ...
      expect(detectMimeType(tiffBEBase64, imageMimeTypeSignatures)).toBe(
        'image/tiff',
      );
    });
  });
  ...
  describe('AVIF', () => {
    it('should detect AVIF from bytes', () => {
      ...
      expect(detectMimeType(avifBytes, imageMimeTypeSignatures)).toBe(
        'image/avif',
      );
    });
    ...
    it('should detect AVIF from base64', () => {
      ...
      expect(detectMimeType(avifBase64, imageMimeTypeSignatures)).toBe(
        'image/avif',
      );
    });
  });
  ...
  describe('HEIC', () => {
    it('should detect HEIC from bytes', () => {
      ...
      expect(detectMimeType(heicBytes, imageMimeTypeSignatures)).toBe(
        'image/heic',
      );
    });
    ...
    it('should detect HEIC from base64', () => {
      ...
      expect(detectMimeType(heicBase64, imageMimeTypeSignatures)).toBe(
        'image/heic',
      );
    });
  });
  ...
  describe('MP3', () => {
    it('should detect MP3 from bytes', () => {
      ...
      expect(detectMimeType(mp3Bytes, audioMimeTypeSignatures)).toBe(
        'audio/mpeg',
      );
    });
    ...
    it('should detect MP3 from base64', () => {
      ...
      expect(detectMimeType(mp3Base64, audioMimeTypeSignatures)).toBe(
        'audio/mpeg',
      );
    });
  });
  ...
  describe('WAV', () => {
    it('should detect WAV from bytes', () => {
      ...
      expect(detectMimeType(wavBytes, audioMimeTypeSignatures)).toBe(
        'audio/wav',
      );
    });
    ...
    it('should detect WAV from base64', () => {
      ...
      expect(detectMimeType(wavBase64, audioMimeTypeSignatures)).toBe(
        'audio/wav',
      );
    });
  });
  ...
  describe('OGG', () => {
    it('should detect OGG from bytes', () => {
      ...
      expect(detectMimeType(oggBytes, audioMimeTypeSignatures)).toBe(
        'audio/ogg',
      );
    });
    ...
    it('should detect OGG from base64', () => {
      ...
      expect(detectMimeType(oggBase64, audioMimeTypeSignatures)).toBe(
        'audio/ogg',
      );
    });
  });
  ...
  describe('FLAC', () => {
    it('should detect FLAC from bytes', () => {
      ...
      expect(detectMimeType(flacBytes, audioMimeTypeSignatures)).toBe(
        'audio/flac',
      );
    });
    ...
    it('should detect FLAC from base64', () => {
      ...
      expect(detectMimeType(flacBase64, audioMimeTypeSignatures)).toBe(
        'audio/flac',
      );
    });
  });
  ...
  describe('AAC', () => {
    it('should detect AAC from bytes', () => {
      ...
      expect(detectMimeType(aacBytes, audioMimeTypeSignatures)).toBe(
        'audio/aac',
      );
    });
    ...
    it('should detect AAC from base64', () => {
      ...
      expect(detectMimeType(aacBase64, audioMimeTypeSignatures)).toBe(
        'audio/aac',
      );
    });
  });
  ...
  describe('MP4', () => {
    it('should detect MP4 from bytes', () => {
      ...
      expect(detectMimeType(mp4Bytes, audioMimeTypeSignatures)).toBe(
        'audio/mp4',
      );
    });
    ...
    it('should detect MP4 from base64', () => {
      ...
      expect(detectMimeType(mp4Base64, audioMimeTypeSignatures)).toBe(
        'audio/mp4',
      );
    });
  });
  ...
  describe('error cases', () => {
    it('should return undefined for unknown image formats', () => {
      ...
      expect(
        detectMimeType(unknownBytes, imageMimeTypeSignatures),
      ).toBeUndefined();
    });
    ...
    it('should return undefined for empty arrays', () => {
      ...
      expect(
        detectMimeType(emptyBytes, imageMimeTypeSignatures),
      ).toBeUndefined();
    });
    ...
    it('should return undefined for arrays shorter than signature length', () => {
      ...
      expect(
        detectMimeType(shortBytes, imageMimeTypeSignatures),
      ).toBeUndefined();
    });
    ...
    it('should return undefined for invalid base64 strings', () => {
      ...
      expect(
        detectMimeType(invalidBase64, imageMimeTypeSignatures),
      ).toBeUndefined();
    });
  });
});
