...
- 78477d3: - Create `/react` sub-package.
  - Create `import { useChat, useCompletion } from '@ai-sdk/react'` and mark React as an optional peer dependency so we can add more framework support in the future.
