import { LanguageModelV1ObjectGenerationMode } from '../v1/language-model-v1';
...
import { LanguageModelV1FinishReason } from '../v1/language-model-v1-finish-reason';
import { LanguageModelV1FunctionToolCall } from '../v1/language-model-v1-function-tool-call';
import { LanguageModelV1LogProbs } from '../v1/language-model-v1-logprobs';
import { LanguageModelV1ProviderMetadata } from '../v1/language-model-v1-provider-metadata';
import { LanguageModelV1Source } from '../v1/language-model-v1-source';

/**
Specification for a language model that implements the language model interface version 1.1.
 */
export type LanguageModelV1_1 = {
  /**
...
on our side.
   */
  readonly specificationVersion: 'v1.1';
...
@return A stream of higher-level language model output parts.
  ...
  doStream(options: LanguageModelV1CallOptions): PromiseLike<{
    stream: ReadableStream<LanguageModelV1_1StreamPart>;
...
export type LanguageModelV1_1StreamPart =
  // Basic text deltas:
