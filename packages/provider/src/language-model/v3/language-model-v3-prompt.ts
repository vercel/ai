...
/**
Tool approval request content part of a prompt. It contains a tool approval request (usually generated by the AI model).
 */
export interface LanguageModelV3ToolApprovalRequestPart {
...
/**
Tool approval response content part of a prompt. It contains a tool approval response (usually generated by the AI model).
 */
export interface LanguageModelV3ToolApprovalResponsePart {
  type: 'tool-approval-response';

  /**
   * ID of the tool approval response.
   */
  approvalId: string;
