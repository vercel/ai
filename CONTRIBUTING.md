...
3. **Add a changeset**: If you're updating any packages and want to ensure they're released, add a changeset to your branch by running `pnpm changeset` in the workspace root. For most chanages you should use a **minor** bump.
